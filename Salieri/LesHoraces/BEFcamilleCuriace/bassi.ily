<<
  \tag #'(fagotto1 fagotto2 fagotti) {
    \clef "tenor" fa1 | fa | mi | fa |
    si4. do'8 re'4. mi'8 |
    fa'1 | mi' |
    fa'4 \twoVoices #'(fagotto1 fagotto2 fagotti) <<

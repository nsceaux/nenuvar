...
<<
  \tag #'(tromba1 trombe) \new Voice {
    \tag #'trombe \voiceOne do''4
  }
  \tag #'(tromba2 trombe) \new Voice {
    \tag #'trombe \voiceTwo mi'4
  }
...
>> r4 r |
r4 r16 sol'32 sol' sol'16 sol' mi' do' mi' sol' |
do''8. do'16 do'4 r |
r8. <<
  \tag #'(tromba1 trombe) \new Voice {
    \tag #'trombe \voiceOne
...
<<
  \tag #'(tromba1 trombe) \new Voice {
    \tag #'trombe \voiceOne do''2
  }
  \tag #'(tromba2 trombe) \new Voice {
    \tag #'trombe \voiceTwo mi'2
  }
>> do''4 re'' |
mi''2 <<
  \tag #'(tromba1 trombe) \new Voice {
    \tag #'trombe \voiceOne mi''2 | re''1 |
  }
  \tag #'(tromba2 trombe) \new Voice {
    \tag #'trombe \voiceTwo do''2 | sol'1 |
  }
>>
do''8 do''16 do'' sol'8 mi' do'4 r |
r do''8. do''16 do''4 do'' |
do''1 |
do''4. do''16 do'' do''8 do'' do'' do'' |
do''4 r r2 |
R1 |
r2 r4 sol'8. sol'16 |
<<
...
>> r4 r8 <<
  \tag #'(tromba1 trombe) \new Voice {
    \tag #'trombe \voiceOne mi''16 mi'' mi''8 mi'' | re''4
  }
  \tag #'(tromba2 trombe) \new Voice {
    \tag #'trombe \voiceTwo do''16 do'' do''8 do'' | sol'4
  }
>> r4 r8 <<
  \tag #'(tromba1 trombe) \new Voice {
    \tag #'trombe \voiceOne re''16 re'' re''8 re'' |
  }
  \tag #'(tromba2 trombe) \new Voice {
    \tag #'trombe \voiceTwo sol'16 sol' sol'8 sol' |
  }
>>
do''2 re''4. re''8 |
sol'4 r r2 |

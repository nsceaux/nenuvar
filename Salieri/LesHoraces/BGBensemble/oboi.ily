...
mi'8 do'[ re' mi'] fa'[ \grace { la'16 sol' fa' } sol'8 la' si'] |
do''4 r r2 |
...
\twoVoices #'(oboe1 oboe2 oboi) <<
  ...
  { s2 si' |
    ...
    la'4 }
  { r2 s | s4 r r8 s4. | s4 r4 r8 s4. | r8 s4. r8 s4. | }
>> r4 r2 |
R1 |
r8 sol'16 sol' sol'8 sol' sol'4 r |
\twoVoices #'(oboe1 oboe2 oboi) <<
  { r4 r8 sol'' do'''2 |
...
\twoVoices #'(oboe1 oboe2 oboi) <<
  ...
  { sol''4 sol'2 sol'4 |
    ...
    mib'4 s mib' s |
    mib' s2. | }
  { s1*3 | r4 s2. | <>\fp s1*9 | r8 s4. r8 s4. |
    r4 s2. |
    s1 |
    r4 s r s |
    s1*3 |

...
mi'4 mi' do'8 sol16 la sib8. do'16 |
la4 la \jonathasMark r r8 fa'' |
re''2 \saulMark r16 la la la fad8. la16 |
re2 re'4 re'16 la la la |
sib4 r16 sib do' re' mib'8. re'16 do' sib la sib |
sol1 \clef "vdessus" r4 sol' |
sol'1 ~ sol'4. fad'8 |
sol'1. |
\clef "vbasse" r2 sol4. sol16 la |
...
fa2 fa \clef "vdessus" r4 do'' |
reb''1 ~ reb''4 do'' |
do''4 \clef "vbasse" r16 la la la re'8 re' si16 si do' re' |
sol4 r8 do'16 sol lab8 fa r16 mib re mib |
do2 do r2 |
\jonathasMark r r4 do'' sol'4. la'8 |
sib'1 sol'2 |
do''1 ( re''4 ) mib'' |
si'1 r2 |
R1.*2 |
...
do''1. |
R1.*4 |
\saulMark r8 la re re r4 r16 re' re' re' |
...
sol'1 ~ sol'4. fad'8 |
sol'1. |
\clef "vbasse" r4 re' r mib'8. mib'16 |
do'4. sib8 la si do'8. re'16 |
si1 \clef "vdessus" r4 do'' |
do''1 ~ do''4. si'8 |
do''1. |
\clef "vbasse" r4 do' do' do' |
sol4. do'8 la4 mi |
fa4. sol8 la4 fa |
do'2 do'4 do |
sol mi fa4. re8 |
...
re'2. si4 |
do' sol re'4. re8 |
sol4 \jonathasMark re''4. re''8 r16 re'' re'' mi'' |
fa''4. mi''16 mi'' mi''4. mi''16 re'' |
mi''8 mi'' \saulMark mi mi la4 la8 si |

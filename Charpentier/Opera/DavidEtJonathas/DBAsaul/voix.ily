...
<<
  ...
  \tag #'saul {
    R1*18 |
    r4 do'^\markup\character "Saül" do'2 ~|
    do'4 sol sol4. la8 |
    sib2. do'4 |
    la2 la4 la |
    re'2 r8 la la la |
...
>>
r4^\markup\italic { Saül poursuit } r8 mib lab4 r16 lab sib do' |
sol4 r16 sib sib do' reb'4. sol8 |
lab4 lab r r8 sib |
sol4. sol16 sib mib4. mib16 fa |
re4. sib8 fa8. fa16 fa8 sol |
lab4 r8 fa16 sol lab4. lab16 sib |
do'8 do' r16 lab sib do' fa8. fa16 fa8 sol |
mib1 |
<<
  \tag #'basse { R1*16 R2.*15 }
  \tag #'saul {
    R1*9 |
    r2 r4 sib |
    sol2 r8 sol lab sib |
    re4 fa8 sol lab4 lab8 sib |
    sol4 sol r r8 mib |
    sol4 sol r sol8 la |
    sib4 sib8 sib do'4. re'16 mib' |
    re'2 r |
    r4 do'2 |
    r4 do'8 sib do' sol |
    lab4. lab8 sib do' |

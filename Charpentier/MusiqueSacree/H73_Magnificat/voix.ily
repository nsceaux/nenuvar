<<
  ...
  \tag #'(vhaute-contre basse) {
    ...
    sib'2. |
    re'4 re'4. re'8 |
    mib'2 do'8\prall sib16 do' |
    re'8[ do' re' mib' re' do']( |
    sib4) sol sol'8 la'16 sib' |
    la'4 re'2 |
    sol'2.~ |
    sol'4( fad'4.) sol'8 |
    sol'2. |
    ...
    r4 r4 fa'4 |
    fa'4. sol'8 mi'4 |
    \origVersion\footnoteGrob #'NoteHead #'(-0.5 . 1) \markup a.
    \markup { a. Haute-contre, mesures 158 à 160 : texte manquant sur trois mesures }
    la'4 la'4. la'8 |
    ...
    sol'4. fa'8 mib'4 |
    fa'4. fa'8 fa'4 |
    fa'4( mi'4.\prall re'8)( |
    mib'4)( re'4.\prall do'8)( |
    re'4)( do'2)\prall |
    sib2. |
    r4 si si |
    si4.( do'16[ re']) si4 |
    ...
    \origVersion\footnoteGrob #'AccidentalCautionary #'(0 . 3.5) \markup a.
    \markup { a. Haute-contre, mesure 259 : altération non explicitée }
  ...
  \tag #'(vtaille basse) {
    ...
    fa' sib do' |
    re'2 la4 |
    sib8[ la sol la sib do']( |
    re'8)[ do' re' mib' fa' re']( |
    sol'4. fad'8) sol'4 |
    fad'2 fad'4 |
    r sol' re' |
    fa' fa' re'~ |
    re'8 mib' do'4( sib8.)\prall la16 |
    sib4( la2)\prall |
    sol2. |
    <<
    ...
    >>
    \tag #'basse \forcedClef "vtaille" re'4 re'4. re'8 |
    sol2 do'4 |
    fad sol la |
    sib sol r |
    la4 la8[ sib] do'[ re'] |
    mib'4( sol8)[ la sib do']( |
    re')[ do' re' la sib do']( |
    ...
    <<
      ...
      \tag #'vtaille {
        ...
        re'4 re'8[ do'] re'[ la] |
        sib4. sib8 sib4 |
        la4 la fad | %% audacieux frottement fa/fa# sur le troisième temps
        sol4.( fad8)[ sol la]( |
        fad4) fad fad |
    ...
    >>
    \tag #'basse \forcedClef "vtaille" sib4. la8 sol4 |
  ...
  \tag #'(vbasse basse) {
    ...
    >>
    \tag #'basse \forcedClef "vbasse" r4 re' do' |
    sib4. la8( sol4) |
    la2 re4 |
    sol8[ fad sol la sib do']( |
    re'2) la4 |
    sib4( la) sol |
    do' la re' |
    re' re'( do') |
    ...
    >>
    \tag #'basse \forcedClef "vbasse" sib4 sib4. do'8 |
    la2\prall la4 |
    sol sol8[ la] sib[ do'] |
    re'[ do' re' do' sib la]( |
    sib4.) la8( sol4) |
    ...
    <<
      ...
      \tag #'vbasse {
        ...
        R2.*3 |
        r4 sib sol |
        la4. sol8( fad4) | %% frottement fa / fa# sur le troisième temps avec basse continue
        sol2 la4 |
        fad4. fad8 fad4 |
        sol sib sol |
        la la la |

...
re' mi' dod' |
re' re' dod' |
re'1 fa'2_\markup\whiteout "sourdines" |
mi'1.~ |
mi'1 do'2 |
re'1 re'2 |
do' re' fa' |
...
fa' dod' re' |
mi'1 r2 |
r2 r sib'_\markup\whiteout "sourdines" |
la'1. |
la'2 la' sol' |
fa' sol'1 |
fa'2 mi' mi' |
...
sol' la' la' |
sol' re' mi' |
fa'2. fa'8*2_\markup\whiteout "sourdines" sol' re' |
mi'1 fa'2 |
mi'1. |
re'1 re'2 |
dod' la' fa' |
...
sol' re' mi' |
fa'2 <<
  \origVersion fad'8*2_\markup\whiteout "fort"
  \modVersion fad'8*2\f >> la' sold' si' |
la'1. |
r2 r la' |
la'1 dod'2 |
re'1 la'2 |
la'8*2 sib' sol' la' fa' sol' |
mi'1. |
sol'8*2_\markup\whiteout "sourdines" fa' sol' la' sol' fa' |
mi' fa' dod' re' mi' dod' |
re'1 dod'2 |
re' sol'1 |
fa'2 mi'2. fa'8*2 |
re'1.~ |
re'2 <<
  \origVersion do'_\markup\whiteout "fort"
  \modVersion do'\f >> do' |
sol'1 sol'2 |
la'2. sol'8*2 fa' mi' |

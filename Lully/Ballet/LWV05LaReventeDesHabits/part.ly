...
\opusPartSpecs #`(
  ...
  (haute-contre "Haute-contre" () (#:notes "haute-contre-rc" #:clef "treble"))
  (taille "Taille" () (#:notes "taille-rc" #:clef "alto"))
  (quinte "Quinte" () (#:notes "quinte-rc" #:clef "alto"))
  (basse "Basse et basse continue" () (#:notes "basse" #:clef "bass")))

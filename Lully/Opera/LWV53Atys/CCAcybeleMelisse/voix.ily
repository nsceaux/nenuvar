<<
  \tag #'(cybele basse) {
    ...
    do''4 << \tag #'cybele do''4 \tag #'basse { do''8 s } >>
    << { s4 s2. s4 } \tag #'cybele { r4 | R2. | r4 } >>
    ...
    r8 re'16 mi' fad'8 fad'16 \footnoteHere #'(0 . 0) \markup {
    ...
    sol'4( fad'2)\trill |
    mi'4
    << { s2 s2.*23 s4 } \tag #'cybele { r2 | R2.*23 | r4 } >>
    \tag #'basse \cybeleMark r8 si' sol'4\trill sol'8 la'16 si' |
    ...
    sol'2 sol'4 |
    << { s2.*17 s1*2 s4 } \tag #'cybele { R2.*17 | R1*2 | r4 } >>
  ...
  \tag #'(melisse basse) {
    << { s1 s4 } \tag #'melisse { \melisseMark R1 | r4 } >>
    \tag #'basse \melisseMark r8 mi'' si'8.\trill si'16 si'8. do''16 |

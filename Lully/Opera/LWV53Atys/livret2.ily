...
\markuplines \column-lines {
  ...
  \livretPersRef #'CDAchoeur \line { Chœurs des Peuples & des Zephirs. }
  \livretVers {
    \sline { Celebrons la gloire immortelle }
    \line { Du Sacrificateur dont Cybele a fait choix : }
    \sline { Atys doit dispenser ses loix, }
    \sline { Honorons le choix de Cybele. }
    \null
  }
  \livretVersRef #'CDDchoeur {
  ...
  \livretPersRef #'CDFchoeur \line { Chœurs des Peuples & des Zephirs. }
  \livretVers {
    \sline { Que la puissante Cybele }
    \sline { Nous rende à jamais heureux. }
  }

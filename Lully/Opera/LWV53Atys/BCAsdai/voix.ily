<<
  ...
  \tag #'(sangaride basse) {
    ...
    mi''[ re''] do''[ si'] si'4( la')\trill |
    sol'1. %{ sol'1 r2 %} |
    r2 re''4-\tag #'sangaride ^\markup\character "Sangaride" re'' do''\trill si' |
    ...
    si' do''( si'8) do'' |
    si'2\trill
    \tag #'sangaride { r4 | R2.*40 | R1 | R2. | R1*15 }
  }
  %% Doris
  \tag #'(doris) {
    ...
    sol'1. %{ sol'1 r2 %} |
    R1.*14 |
    r2 fad'4.^\markup\character "Doris" sol'8 |
    la'2 la'4. la'8 |
    la'4 la' la'4. la'8 |
    sol'4 sol' sol'2 |
    mi' mi'4. fad'8 |
    ...
    sol'2 r |
    R1*31 R1. R2.*65 R2.*40 R1 R2. R1 R1*14
  }
  %% Atys
  \tag #'(atys basse) {
    ...
    << { s2 s1.*3 s1*33 s2. }
      \tag #'atys { r2 | R1.*3 |
        r2 re'4.^\markup\character "Atys" re'8 |
        mi'2 mi'4. mi'8 |
        fa'4 fa' fa'4. fa'8 |
        fa'?4 mi' re'2\trill |
        do' do'4. do'8 |
  ...
  \tag #'idas {
    \idasMark R1*12
    R1.*15 |
    r2 re4.^\markup\character "Idas" re8 |
    la,2 la4. la8 |

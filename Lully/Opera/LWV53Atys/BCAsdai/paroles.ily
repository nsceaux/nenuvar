...
%Sangaride
\tag #'(sangaride basse) {
  Les dieux sui -- vent ses loix et crai -- gnent son cou -- roux.
}
%Atys, Sangaride, Idas, Doris
\tag #'(sangaride doris atys idas basse) {
...
\tag #'(atys basse) {
  ...
  j'aime à les voir s'em -- bel -- lir,
...
%Sangaride
\tag #'(sangaride basse) {
  Quand le pé -- rile est a -- gré -- a -- ble,

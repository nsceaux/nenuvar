...
\markuplist \fontsize-lines #2 \column-lines {
  ...
  \score {
    <<
      { \startQuote #5 \time 4/4 \key sol \major \clef "soprano"
        \set autoBeaming = ##f
  ...
  \score {
    <<
      { \set autoBeaming = ##f
        \startQuote #22 \time 4/4 \key sol \major \clef "varbaritone"
  ...
  \score {
    <<
      { \set autoBeaming = ##f
        \startQuote #31 \time 4/4 \key sol \major \clef "soprano"
  ...
  \score {
    <<
      { \set autoBeaming = ##f \startQuote #15 \time 4/4
        \key sol \major \clef "soprano"
  ...
  \score {
    <<
      { \set autoBeaming = ##f \startQuote #29 \time 3/4
        \key sol \major \clef "soprano"
  ...
  \score {
    <<
      { \set autoBeaming = ##f \startQuote #36 \time 3/4
        \key sol \major \clef "soprano"
  ...
  \score {
    <<
      { \set autoBeaming = ##f \startQuote #79 \time 3/4
        \key sol \major \clef "soprano"
        si'4 do'' re'' | do''2. |

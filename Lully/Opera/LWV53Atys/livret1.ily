...
\markuplines \column-lines {
  ...
  \livretPersRef #'BAAatys \line { ATYS. }
  \livretVers {
  ...
  \livretPersRef #'BBAatysIdas \line { IDAS, ATYS. }
  \livretVers {
    \sline { Allons, allons, accourez tous, }
    \sline { Cybele va descendre. }
  }
  ...
  \livretPers ATYS.
  \livretVers {
    \line { Sur l'Univers entier son pouvoir doit d'étendre. }
  }
  \livretPers SANGARIDE.
  \livretVers {
  ...
  \livretVers {
    ...
    \sline { Tous nos Phrygiens s'avancer. }
  }
  \livretPers DORIS.
  \livretVers {
    \sline { Je vais prendre soin de presser }
    \sline { Les Nymphes nos Compagnes. }
  }
  %%%
  ...
  \livretPers ATYS.
  \livretVers {
    \line { \invisible { O dieux ! } Ce n'est qu'à vous que je veux reveler }
  ...
  \livretPers ATYS.
  \livretVers {
    \line { \invisible { Quoy ? vous ? Il est trop vray. Vous m'aimez ? } Je vous aime. }
    \sline { Vous me condamnerez vous mesme, }
    \sline { Et vous me laisserez mourir. }
  ...
  \livretPers ATYS.
  \livretVers {
    \line { \invisible { Helas ! } Vous soûpirez ? je voy couler vos pleurs ? }
  ...
  \livretDesc \column {
    ...
    \wordwrap\italic {
      Six Phrygiens daçans.
    }
    \wordwrap\italic {
      Six Nimphes Phrygiennes daçantes.
    }
  }
  \livretPersRef #'BGAatysSangarideChoeur ATYS.
  \livretVers {
  ...
  \livretPersRef #'BHBcybeleChoeur \line { CYBELE sur son Char. }
  \livretVers {

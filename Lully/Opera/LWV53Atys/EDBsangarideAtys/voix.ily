<<
  ...
  \tag #'(sangaride basse) {
    ...
    \tag #'basse \sangarideMark r8 \footnoteHere #'(0 . 0) \markup {
    ...
    \tag #'basse \sangarideMark r8 sib' mib''8. mib''16 mib''8. mib''16 |
    do''8\trill do'' r do'' lab'8.\trill lab'16 lab'8. do''16 |
    ...
    fad'4 fad'8 re'' re''4. re''8 |
    si'4.\trill si'8 do''4 do''8 sol' |
    lab'4 lab'8. lab'16 sol'8\trill sol'16 do'' do''8 do'' |
    la'8.\trill la'16 la'8 la' sib'4. sib'8 |
    sol'4\trill do''8 do'' fa'4 fa'8. sib'16 |
    sol'8\trill sol'
    << { s2 s2. } \tag #'sangaride { r2 | r2 r4 } >>
    \tag #'basse \sangarideMark r8 fa'' |
    re''4\trill re''8. re''16 la'4 la'8. re''16 |
    si'4\trill
    << { s2. s4 } \tag #'sangaride { r4 r2 | r4 } >>
    \tag #'basse \sangarideMark fa''8. re''16 mib''8. do''16 la'8\trill sib'16 do'' |
    fad'8\trill fad' re''8. re''16\trill si'4 r8 si' |
    do''4 do''8. do''16 la'4\trill la'8. re''16 |
    sol'4 sol'8 do'' la'\trill la'16 la' la'8[ sol'16] la' |
    sib'8 sib' << \tag #'sangaride sol'4\trill \tag #'basse { sol'8 s } >>
    << s4 \tag #'sangaride r4 >>
    \tag #'basse \sangarideMark re''8. re''16 |
    si'4 do''8. mib''16 si'4 do''8[ si'16] do'' |
    do''2( si'4.\trill) do''8 |
    do''4 r8 mib''16 mib'' sol'8\trill sol'16 la' |
    ...
    do''8 do''16 do'' \footnoteHere #'(0 . 0) \markup {
      Manuscrit : \raise #3 \score {
        <<
          { \tinyQuote \set autoBeaming = ##f
    ...
    la'4\trill fa''8. fa''16 sib'4 r8 sib'16 sib' |
    sol'4\trill r8 sib'16 sib' mib''8 mib''16 mib'' |
    do''8\trill do'' r16 re'' re'' re'' re''8[ mib''16] fa'' |
    si'4\trill re''8. mib''16 do''4 do''8. si'16 |
    ...
    sol'4 r8 do'' re'' mib'' re''8.\trill mib''16 |
    mib''4
    << { s2 } \tag #'sangaride { r4 r } >>
    \tag #'basse \sangarideMark re''8. re''16 |
    sol'4 r8 do'' do'' sib' la'8.\trill sol'16 |
    sol'4 si'8. si'16 do''4 do''8. sol'16 |
    lab'4 lab'8 lab'16 lab' sib'8. do''16 |
    fa'4\trill << \tag #'sangaride fa'4 \tag #'basse { fa'8 s } >>
    << { s4 s2. s1*24 }
  ...
  %% Atys
  \tag #'(atys basse) {
    \atysMark r2 r8 mib'16 mib' do'8 do'16 do' |
    lab4. lab16 do' lab8\trill lab16 sol |
    sol4\trill sol r8 sol16 sol do'8 do'16 re' |
    mib'4 mib' sol8.\trill sol16 sol8 la |
    sib4 sib r8 re'16 re' si8 si16 do' |
    re'4 re'8. re'16 mib'4 mib'8. fa'16 |
    re'4\trill
    ...
    \tag #'basse \atysMark r8 sol' mib'\trill mib'16 sol' |
    do'4 do'8. do'16 la4\trill 
    ...
    << { s2. s1*3 s4. }
      \tag #'atys {
        r4 r2 |
        r2 r4 r8 re' |
        mib'4 mib'8. mib'16 do'4\trill do'8 fa' |
        sib4 sib8 mib' do'\trill do'16 re' mib'8[ re'16] mib' |
        re'4\trill r8
      }
    >>
    ...
    << { s4 s1*2 s2. s1 s4 } \tag #'atys {
        fa'8. fa'16 |
        re'4\trill mib'8. sol'16 re'4 mib'8[ re'16] mib' |
        mib'2( re'4.)\trill do'8 |
        do'4 r2 |
        R1 |
        r4
      } >>
    \tag #'basse \atysMark r8 fa'16 fa' do'8 do'16 re' |
    mib'8. mib'16 mib' mib' mib' sol' do'8 do'16 do' do'8 re'16 mib' |
    fa'8. re'16 la4\trill la8 si16 do' |
    si8 si sol'8. re'16 re'8 re'16 re' |
    mib'8 mib'16 sol' mib'8\trill mib'16 mib' do'8\trill do' |
    fa' fa'16 fa' fa'8 sol' do'8.\trill re'16 |
    sib4 r8 fa' re'8.\trill re'16 re'8. re'16 |
    mib'4 sib8. do'16 lab4\trill sol8 lab |
    << \tag #'atys { sol4\trill sol } \tag #'basse { sol8\trill sol s4 } >>
    << { s2 s1 s2. s2 } \tag #'atys { r2 | R1 | R2. | r2 } >>
    \tag #'basse \atysMark si4 si8 si |
    do'4 r \footnoteHere #'(0 . 0) \markup {
      Manuscrit : \raise #3 \score {
        <<
          { \tinyQuote \set autoBeaming = ##f
            \key sol \minor \clef "alto" \time 4/4
    ...
    sol4\trill r8 sol' \footnoteHere #'(0 . 0) \markup {
      Manuscrit : \raise #3 \score {
        <<
          { \tinyQuote \set autoBeaming = ##f
            \key sol \minor \clef "alto" \time 4/4
    ...
    \tag #'basse \atysMark fa'8 re'\trill re'
    << { s4 s1 s4 } \tag #'atys {
        r4 |
    ...
    re'2.\trill sol'4 |
    lab'2 fa'4 fa'8 fa' |
    re'2\trill mib'4. \footnoteHere #'(0 . 0) \markup {
      Manuscrit : \raise #3 \score {
        <<
          { \tinyQuote \set autoBeaming = ##f
    ...
    re'4\trill re' r8 sol16 sol sol8 la16 si |
    do'4 do'8 do' do'4 re'8 mi' |
    la8\trill la do'16 do' re' mi' fa'8 fa'16 fa' |
    re'8\trill sol' do' do' do' si |
    do'2. |
  }
>>
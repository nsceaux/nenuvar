<<
  %% Sangaride
  \tag #'(sangaride basse) {
    << { s1*3 | s2. } \tag #'sangaride { \sangarideMark R1*3 | r2 r4 } >>
    ...
    fad'8\trill fad' \footnoteHere #'(0 . 0) \markup {
       Manuscrit : \raise #4 \score {
         <<
           ...
           } \addlyrics { mes -- me, j'ac -- cep -- te -- ray sans pei -- ne }
         >>
         \layout { \quoteLayout }
       }
    } r16 la' la' la' la'8 si' |
    ...
    si'8 si' mi''8. si'16 dod''8 \footnoteHere #'(0 . 0) \markup {
      Manuscrit : \raise #3 \score {
        <<
          ...
          } \addlyrics { coi -- re un dé -- pit qui sert à sa gloi -- re. }
        >>
        \layout { \quoteLayout }
      }
    } red''8 mi'' mi''16 red'' |
    ...
    \tag #'basse \sangarideMark re''8 si'\trill si'16 si' si'8 re'' |
    sol'4 r16 sol' sol' sol' do''4 do''8 re'' |
    mi'' mi'' r mi''16 sol'' do''8. do''16 do''8. mi''16 |
    la'8\trill la' re'' re''16 mi'' la'4\trill la'8. si'16 |
    sol'2 %{%} re''4 re''8 re'' |
    mi''4. mi''8 re''4.\trill do''8 |
    si'4\trill si' re''4. re''8 |
    ...
    la'4. la'8 si'4 si' |
    do''2 do''4( si'8) do'' |
    si'4.\trill si'8 si'4 do'' |
    re''4 re'' do''4.\trill si'8 |
    la'4\trill la' re''2~ |
    re''4. re''8 do''4. si'8 |
    la'2\trill si'4 do'' |
    si'1\trill |
  ...
  %% Doris
  \tag #'(doris basse) {
    \dorisMark r2 re''4 sol'8. sol'16 |
    mi'4\trill
    << { s2. | s2 } \tag #'doris { r4 r2 | r2 } >>
    \tag #'basse \dorisMark r8 sol'16 la' si'8\trill si'16 dod'' |
    re''8 re''16 re'' mi''8 mi''16 mi'' la'8\trill la'
    << { s4 | s2 } \tag #'doris { r4 | r2 } >>
    \tag #'basse \dorisIdasMark r8 re'' re'' mi'' |
    do'' do''16 re'' si'8\trill si'16 do'' la'4\trill
    ...
    dod''4 re''8. la'16 sol'4\trill sol'8. la'16 |
    fad'4\trill << \tag #'doris fad'4 \tag #'basse { fad'8 s } >>
    << { s2 | s2. | s1*5 | s2. | s8 } \tag #'doris { r2 | R2. | R1*5 | R2. | r8 } >>
    \tag #'basse \dorisIdasMark si'8 si'8. si'16 do''8. do''16 |
    ...
    \tag #'basse \dorisIdasMark \tag #'() \peutOnChanger
    sol'4
    << { s2. | s1*4 | s2.*4 | s1 } \tag #'doris { r4 r2 | R1*4 | R2.*4 | R1 } >>
    \tag #'basse \dorisIdasMark \tag #'() \peutOnChanger
    sol'2 r |
    << { s1*9 | s2.*5 | s1*8 } \tag #'doris { R1*9 | R2.*5 | R1*8 } >>
    \tag #'basse \dorisIdasMark si'4 si'8 si' si'4. si'8 do''4. re''8 |
    mi''2 mi''4 mi'' re''4.\trill do''8 |
    si'4\trill si' si' do'' |
    re''4. re''8 do''4. si'8 |
    la'2\trill la' |
    r4 si' si' do'' |
    la'\trill la' la' si' |
    sold' mi'' fa''4. mi''8 |
    re''4.\trill do''8 do''4( si')\trill |
    la'1 |
    r4 la' la' sol' |
    fad'4\trill fad' fad'8[ mi'] fad'4 |
    sol' re'' re'' do'' |
    si'\trill si' do'' re'' |
    mi'' do'' la' re'' |
    si'\trill do'' si'( la')\trill |
    sol'4
    \tag #'doris {
      r4 r2 |
      R1*3 |
      r2 si'4 si'8 si' |
      do''4. do''8 si'4.\trill la'8 |
      sol'4 sol' si'4. si'8 |
      ...
      si'4 si' la'4.\trill sol'8 |
      fad'4\trill fad' si'2~ |
      si'4. si'8 la'4.\trill sol'8 |
      sol'2 fad'4.\trill sol'8 |
      sol'1 |
    }
  }

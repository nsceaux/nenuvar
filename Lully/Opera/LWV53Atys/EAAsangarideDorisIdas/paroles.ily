...
% Sangaride
\tag #'(sangaride basse) {
  J'em -- bar -- ras -- sais A -- tys, je l'ai vu se trou -- "bler :"
  je croy -- ais de -- voir ré -- vé -- ler
  notre a -- mour à Cy -- bè -- "le ;"
  mais l'in -- grat, l'in -- fi -- dè -- le,
  m'em -- pê -- chait tou -- jours de par -- ler.
}
% Doris, et Idas.
\tag #'(doris idas basse) {
  Peut- on chan -- ger si tôt quand l'a -- mour est ex -- trè -- "me ?"
...
\tag #'(idas) {
  ...
  si tôt qu'on l'a rap -- pel -- le.
  Et la rai -- son ne re -- vient pas,
  et la rai -- son, et la rai -- son ne re -- vient pas
  si tôt qu'on l'a rap -- pel -- le.
}
% Sangaride
\tag #'(sangaride basse) {
  A -- prés u -- ne tra -- hi -- son

<<
  ...
  \tag #'(sangaride basse) {
    ...
    re''2. |
    r8 re'' re''4 dod'' |
    re''2 la'8 %{ sib' %} \footnoteHere #'(0 . 0)
    \markup {
    ...
    fa'4. sol'8 la' %{ sib' %} \footnoteHere #'(0 . 0)
    \markup {
      Manuscrit : \raise #4.5 \score {
        <<
          \new Staff {
    ...
    r8 re'' re''4 dod'' |
    re'' 
    << { s2.*2 s2 } \tag #'sangaride { r4 r2 | R2. | r2 } >>
    \tag #'basse \sangarideMark r8 la'16 la' la'8 la'16 la' |
    ...
    re''4 dod''4.\trill re''8 |
    re''2
    << { s1*4 } \tag #'sangaride { r2 | R1*3 | r2 } >>
    \tag #'basse \sangarideMark r4 la'8 la' |
    ...
    la'2
    << { s2 s1 s2.*20 s1*2 s4. } \tag #'sangaride { r2 | R1 | R2.*20 | R1*2 | r4 r8 } >>
    \tag #'basse \sangarideMark do''8 do'' la' sib' do'' |
  ...
  \tag #'(doris basse) {
    ...
    re'' r8 re''16 re'' la'8. %{ sib'16 %} \footnoteHere #'(0 . 0)
    \markup {
      Manuscrit : \raise #4.5 \score {
        <<
          \new Staff {
    ...
    dod''4 dod''
    << { s1*10 } \tag #'doris { r2 | R1*9 | r2 } >>
    \tag #'basse \dorisMark fa'8 fa'16 fa' sol'8. la'16 |

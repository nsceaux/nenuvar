...
%{ n°11 %}
\pieceTocTitle "Deuxième entrée des songes funestes"
...
\pieceToc \markup \smallCaps { Cybèle, Atys, Sangaride }
...
\pieceToc \markup { \smallCaps Cybèle :
  \italic { Espoir si cher et si doux } }

<<
  ...
  \tag #'(cybele basse) {
    ...
    si'4 si'
    << { s2 s1 s8 } \tag #'cybele { r2 | R1 | r8 } >>
    \tag #'basse \cybeleMark mi''8 la'16 la' la' la' mi'8\trill mi'16 mi' la'8 la'16 la' |
    ...
    \tag #'basse \cybeleMark re''4 r si'16 si' si' si' |
  ...
  \tag #'(celaenus basse) {
    ...
    re4
    << { s2. s1*6 s2 } \tag #'celaenus { r4 r2 | R1*6 | r2 } >>
    \tag #'basse \celaenusMark r8 sol sol sol |
    mi4\trill mi mi' r8 dod'16 dod' |
    << \tag #'celaenus { la8\trill la } \tag #'basse { la16\trill la s8 } >>
    << { s2. s1 s2.*3 s1*2 s4 } \tag #'celaenus { r4 r2 | R1 | R2.*3 | R1*2 | r4 } >>
    \tag #'basse \celaenusMark r8 mi' la4 r8 la |
    mi8.\trill mi16 mi8. fad16 sol8. sol16 sol8. fad16 |
    fad4\trill
    << { s2. s2. s1*2 s2. s1*2 s2.*2 s1*3 s2. s1*2 s4 }
      \tag #'celaenus { r4 r2 | R2. | R1*2 | R2. |

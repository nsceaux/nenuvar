...
r8 mi''16 mi'' do''8 do''16 mi'' \myfootnote #'NoteHead #'(0 . 2) \markup {
  Manuscrit : \raise #3 \score {
    <<
      \new Staff {
        \tinyQuote \time 4/4 \set autoBeaming = ##f
        \key do \major \clef "soprano"
        r8 mi''16 mi'' do''8\trill do''16 mi'' la'8 la'16 la' mi'8 fa'16 sol' |
        mi'8 mi'
      } \addlyrics {
...
fa''2 re''4.\trill do''8 |
do''2( si'4.)\trill la'8 |
\myfootnote #'NoteHead #'(0 . 2) \markup\justify {

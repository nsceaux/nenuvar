<<
  ...
  \tag #'(cybele basse) {
    ...
    dod''4 dod'' r2 |
    << { s1*3 s4 s16 } \tag #'cybele { R1*3 | r4 r16 } >>
    \tag #'basse \cybeleMark re''16 re'' re'' sol'8. sol'16 la'8. sib'16 |
    la'4\trill << \tag #'cybele la'4 \tag #'basse { la'8 s } >>
    << { s2 s1 s4 } \tag #'cybele { r2 | R1 | r4 } >>
    \tag #'basse \cybeleMark r8 sol'16 la' sib'8 sib'16 do'' |
    re''8. re''16 sib'8.\trill sib'16 sib'8. sib'16 |
    la'8\trill la'
    << { s2 s2.*2 s1 s2. s4 } \tag #'cybele { r2 | R2.*2 | R1 | R2. | r4 } >>
    \tag #'basse \cybeleMark r8 mi'' fa'' fa'' r re''16 re'' |
    sib'8. sib'16 sol'8\trill sol' r8 do''16 do'' fa''8 fa''16 do'' |
    re''8 do'' sib' la' sol'4.\trill la'8 |
    fa'4 << \tag #'cybele fa'4 \tag #'basse { fa'16 s8. } >>
    << { s2 s1*3 s2 } \tag #'cybele { r2 | R1*3 | r2 } >>
    \tag #'basse \cybeleMark r8 fa'16 sol' la'8\trill la'16 si' |
    do''8. do''16 fa''8. si'16 si'8. do''16 |
    do''8 do'' r la' fad' fad'16 fad' sol'8 sol'16 la' |
    << \tag #'cybele sib'4 \tag #'basse { sib'8 s } >>
    << { s2. s1 s4. } \tag #'cybele { r4 r2 | R1 | r4 r8 } >>
    \tag #'basse \cybeleMark la'8 sol'8.\trill sol'16 sol'8. la'16 |
  ...
  \tag #'(sangaride basse) {
    ...
    la'4
    << { s2. s1*2 s4 s16 } \tag #'sangaride { r4 r2 | R1*2 | r4 r16 } >>
    ...
    la'4\trill << \tag #'sangaride la'4 \tag #'basse { la'8 s } >>
    << { s2 s1 s8 } \tag #'sangaride { r2 | R1 | r8 } >>
    \tag #'basse \sangarideMark dod''16 dod'' dod''8 dod''16 dod''
    << \tag #'sangaride re''4 \tag #'basse { re''8 s } >> 
    << { s4 s4. } \tag #'sangaride { r4 | r4 r8 } >>
    \tag #'basse \sangarideMark do''8 sol'8. sol'16 sol'8 la' |
    sib'4 la'8. la'16 la'8 la'16 sol' |
    la'2 la' |
    la'8. la'16 sol'8 fa'\trill mi'4 mi'8.\trill fa'16 |
    re'2 r4 |
    \tag #'sangaride { R2.*14 | R1*2 | R2. | R1*2 | R2. | R1 | R2.*2 }
  }
  ...
  \tag #'atys {
    ...
    sib4 sib r2 |
    r4 r8 do' do'8. do'16 do'8 re' |
    mi'8. mi'16 mi'8. mi'16 fa'4. sol'8 |
    mi'4\trill r2 |
    R2. |
    r4 r8 fa'16 fa' re'8\trill re'16 mi' |
    ...
    dod'4 r r2 |
    R1*2 |
    r4 r16 do' do' do' dod'8. dod'16 dod'8. dod'16 |
    ...
    R2. |
    R1 |
    r8 sol'16 sol' re'8\trill re'16 sol' mi'8.\trill mi'16 mi' mi' mi' fa' |
  ...
  \tag #'celaenus {
    ...
    la4 la r2 |
    R1*3 |
    r4 r16 sol sol sol do'8. do'16 do'8 do |
    fa4 fa r2 |
    R1 |
    r4 r8 do16 do sol8 sol16 la |

<<
  %% Sangaride
  \tag #'(sangaride basse) {
    << { s2 | s2. | s4. } \tag #'sangaride { \sangarideMark r2 | R2. | r4 r8 } >>
  ...
  \tag #'(celaenus basse) {
    ...
    sold4. la8 si do' si8.\trill la16 |
    la4 r8 mi' la8. la16 la8. la16 |
    fad4 re' r8 fad sol8 sol16 la |
    ...
    fad4 la8. la16 sib4 la8.\trill sol16 |

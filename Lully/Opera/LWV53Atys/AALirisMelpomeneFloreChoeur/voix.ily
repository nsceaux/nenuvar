<<
  ...
  \tag #'(flore basse) {
    ...
    la'4.\trill si'8 do''4 |
    si'2\trill si'4 |
    << { s2.*10 } \tag #'flore { R2.*10 | } >>
    \tag #'basse \floreMark re''4 re'' mi'' |
    re''2\trill
    << { s4 s2.*6 } \tag #'flore { r4 | R2.*6 | } >>
    \tag #'basse \floreMark la'4 la' si' |
    do''2. |
    si'4 do''8[ si'] la'[ sol'] |
    la'2
    << { s4 s2.*6 } \tag #'flore { r4 | R2.*6 | } >>
    \tag #'basse \floreMark mi''4 mi''4 fad'' | % mi''4. fa''8
    mi''2\trill
    << { s4 s2.*14 } \tag #'flore { r4 | R2.*14 | } >>
    \tag #'basse \floreMark la'4 la' si' |
    do''2. |
    si'4 do''8[ si'] la'[ sol'] |
    la'2

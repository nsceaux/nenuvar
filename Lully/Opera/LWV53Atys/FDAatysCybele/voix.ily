<<
  ...
  \tag #'(cybele basse) {
    ...
    \tag #'basse \cybeleMark re''8 si'16\trill si' si' re'' sol'8. sol'16 do'' do'' do'' mi'' |
    la'8\trill la' r do''16 do'' fa''8 fa''16 fa'' |
    re''4\trill re''8 sol'' do''4 do''8 si' |
    do''4
    << { s2 s1*8 s2. s4 } \tag #'cybele { r2 | R1*8 | R2. | r4 } >>
    \tag #'basse \cybeleMark r16 la' la' la' fad'4 r8 re'' |
    si'\trill si' r4
    ...
    \tag #'basse \cybeleMark mib''8 si'8 si'16 si' si'8 si'16 re'' |
    ...
    \tag #'basse \cybeleMark r8 do'' la'8.\trill la'16 la'8. la'16 |
    fad'4 r4
  ...
  \tag #'(atys basse) {
    ...
    si2\trill r |
    << { s1*7 } \tag #'atys { R1*7 } >>
    \tag #'basse \atysMark r4 mi' do'8. do'16 do'8. sol16 |
    ...
    mib'8. mib'16 sib8. do'16 re'8 re'16 mib' mi'8\trill mi'16 fa' |

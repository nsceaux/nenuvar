...
fa4 fa8. sol16 lab4 lab8. \myfootnote #'NoteHead #'(0 . 1) \markup {
  Manuscrit : \raise #3 \score {
    <<
      { \tinyQuote \set autoBeaming = ##f
        \time 4/4 \key re \minor \clef "bass"
...
sol4\trill mib8 fa sol4\trill sol8 la |
sib4 sib8 sib si4 si8 do' |
do'2 r8 mi mi mi |
fa4. fa8 fa4 mi |
fa fa r do8 re |
mib!4 mib8 fa sol4 sol8 la |
sib4. la16 sol fad4\trill r8 re' |
...
la4\trill la8 \myfootnote #'NoteHead #'(0 . 1) \markup {
  Manuscrit : \raise #3 \score {
    <<
      { \tinyQuote \set autoBeaming = ##f
        \time 4/4 \key re \minor \clef "bass"

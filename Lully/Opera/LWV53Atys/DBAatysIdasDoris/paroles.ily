\tag #'(idas basse) {
  % Idas
  Peut- on i -- cy par -- ler sans fein -- "dre ?"
}
\tag #'(atys basse) {
  % Atys
...
\tag #'(atys basse) {
  % Atys
  Vous de -- vez a -- vec moy par -- ta -- ger mon bon -- heur.
}
\tag #'(doris idas basse) {
  % Doris et Idas
...
\tag #'(atys basse) {
  % Atys
  Je ne puis me re -- soudre à cet -- te vi -- o -- len -- ce.
}
\tag #'(doris idas atys basse) {
  ...
  \tag #'(doris atys basse) {
    L'A -- mour, l'A -- mour toû -- jours em -- por -- te la ba -- lan -- ce.
  }
}
\tag #'(atys basse) {
  % Atys

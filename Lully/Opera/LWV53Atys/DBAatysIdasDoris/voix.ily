<<
  %% Doris
  \tag #'(doris basse) {
    << { s1*2 s2. s4. } \tag #'doris { \dorisMark R1*2 | R2. | r4 r8 } >>
    \tag #'basse \dorisMark re''8 sib' sib' sib' sib' |
    sol'4\trill
    ...
    \tag #'basse \dorisMark r8 mib''16 mib'' sol'8\trill sol'16 la' sib'8. do''16 |
    ...
    si'4 si' do'' re'' |
    mib'' re'' do''( si'?8) do'' |
    si'2 %{ si'4. re''8 %} si'4 re'' |
    mib''4. re''8 do''4. sib'8 |
    la'4\trill la' sib'8[ la'] sib'4 |
    sib'2( la') |
    sib'2 r |
    r2 r4 r8 la' |
    fad'2. r8 la' |
  ...
  %% Atys
  \tag #'(atys basse) {
    << { s1. } \tag #'atys { \atysMark R1 | r2 } >>
    \tag #'basse \atysMark r8 sib16 do' re'8\trill re'16 mi' |
    ...
    la4\trill sib8 sib16 sib sib8 do' |
    re'2 re'4 |
    << { s2.*31 s4 } \tag #'atys { R2.*31 | r4 } >>
    \tag #'basse \atysMark r8 re'16 re' sib8\trill sib r mib' |
    do'4\trill r8 fa' fa'4 r16 re' re' re' |
    sol4
    ...
    << { s2 s1*22 } \tag #'atys {
        ...
        sib2 sib4 mib' |
        do'2\trill do'4 fa' |
        re'4.\trill re'8 re'4. re'8 |
        do'4.\trill do'8 %{ do'4. re'8 %} do'4 re' |
        mib'2. mib'4 |
        re'4.\trill re'8 re'4. re'8 |
        re'4 re' re'( do') |
        re'2. re'4 |
        ...
        sol'2( fad') |
        sol'2 r | } >>
    \tag #'basse \atysMark r8 sib16 sib si8\trill si16 do' re'8 re'16 mib' fa'8 mib'16 re' |
    mib'4 r8 do' sol\trill sol16 la sib8 sib16 la |
    la2\trill sib8 sib16 sib do'8 re' |
    mib'4 r8 do' la8.\trill la16 la8. sib16 |
    sol2 sol4 |
  }
  ...
  \tag #'(idas basse) {
    ...
    \tag #'idas {
      ...
      sib8\trill sib r sib16 sib do'8. do'16 do'8. do'16 |
      la4\trill r r2 |
      R1 |
      ...
      sib,2 sib,4 |
      fa2 re4 |
      sol sol %{ mi8 mi %} mi8. mi16 |
      la2 sib4 |
      sol la la, |
      re2. |
      sol4 sol fa |
      %{ mib4 mib %} mib4. mib8 re4 |

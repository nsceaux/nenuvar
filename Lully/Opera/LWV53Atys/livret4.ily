...
\markuplines \column-lines {
  ...
  \livretPersRef #'EEBsangarChoeur \line { Le Dieu du Fleuve Sangar. }
  \livretVers {
  ...
  \livretPersRef #'EECsangarChoeur \line { Le Dieu du Fleuve Sangar. }
  \livretVers {
  ...
  \livretPersRef #'EEDfluteChoeur \center-column {
  ...
  \livretPersRef #'EEGduo \center-column {
  ...
  \livretPersRef #'EEIchoeur \line {
    Chœur de Dieux de Fleuves, & de Divinitez de Fontaines.
  }
  \livretVers {
    \sline { Un grand calme est trop fascheux, }
    \sline { Nous aimons mieux la tourmente. }
    \sline { Que sert un cœur qui s'exempte }
    \sline { De tous les soins amoureux ? }
    \sline { A quoy sert une eau dormante ? }
    \sline { Un grand calme est trop fascheux, }
    \sline { Nous aimons mieux la tourmente. }
  }
  %%
  ...
  \livretPersRef #'EFAchoeur
  \line { Chœur de Dieux de Fleuves, & de Fontaines. }
  \livretVers {
  ...
  \livretVers {
    \sline { Aprenez, audacieux, }
    \sline { Qu'il n'est rien qui n'obeïsse }
    \line { Aux souveraines loix de la Reyne des Dieux. }
    \sline { Qu'on nous enleve de ces lieux ; }
    \line { Zephirs, que sans tarder mon ordre s'accomplisse. }
  }
  \livretDesc \wordwrap-center {

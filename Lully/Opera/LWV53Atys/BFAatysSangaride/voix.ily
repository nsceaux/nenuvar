<<
  ...
  \tag #'(sangaride basse) {
    ...
    << { s4 s1*5 s4 } \tag #'sangaride { r4 | R1*5 | r4 } >>
    ...
    fad'8 fad' r16 la' la' si' sol'4 sol'8 sol'16 fad' | % sol'8. sol'16 sol'8. fad'16
    sol'4
    ...
    do''4
    << { s2. s1 s2. s1 s2 } \tag #'sangaride { r4 r2 | R1 | R2. | R1 | r2 } >>
  ...
  \tag #'(atys basse) {
    ...
    si4
    << { s2 s2. s1 s8 } \tag #'atys { r2 | R2. | R1 | r8 } >>
    ...
    sold4 r8 sold16 sold la4 si8. do'16 | % la4. si16 do'
    si4 si r8 sold |
    ...
    \tag #'basse \atysMark %{r8 mi' do'4 la |
    re' re' si |
    do'2 la4 |
    r mi' fa' |
    sol'2 mi'4 |

<<
  ...
  \tag #'(sangaride basse) {
    ...
    do''16 do'' do'' do'' sol'\trill sol' sol' la' sib'8. do''16 |
    la'4\trill
    << { s2. s2. s1 s2. s4. }
    ...
    \tag #'basse \sangarideMark r4
    r8-\tag #'sangaride ^\markup\character "Sangaride" do'' |
    la'2\trill r
  ...
  \tag #'(cybele basse) {
    ...
    \tag #'basse \cybeleMark re''8-\tag #'cybele ^\markup\character "Cybèle"
  ...
  \tag #'(atys basse) {
    ...
    re'8\trill re'16 fa' sib8 sib16 re' sol4 r8 sol'16 sol' |
    ...
    \tag #'basse \atysMark r8 do'-\tag #'atys ^\markup\character "Atys"
    ...
    \tag #'basse \atysMark r8 fa'-\tag #'atys ^\markup\character "Atys"
    re' fa' sib sib r sol' |
    mi'4\trill r8 la' fa'\trill fa' fa' mi' |
    fa' fa'
    \tag #'atys { r4 r2 | R1*13 R1*3 R2. R1*3 R2.*2 R1*2 }
  }
  %% Celænus
  \tag #'(celaenus basse) {

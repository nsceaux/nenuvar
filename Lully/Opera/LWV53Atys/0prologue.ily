...
\pieceToc \markup \smallCaps { Le Temps }
\includeScore "AABleTemps"
%{ n°3 %}
\pieceToc \markup { \smallCaps { Chœur des Heures : }
  \italic { Ses justes lois } }
\includeScore "AACchoeur"
%{ n°4 %}\newBookPart #'(full-rehearsal)
\pieceTocTitle "Air pour Flore"
\includeScore "AADair"
%{ n°5 %}
\pieceToc \markup \smallCaps { Le Temps, Flore }
...
%{ n°9 %}
\pieceTocTitle "Prélude pour Melpomène"
\includeScore "AAIair"
%{ n°10 %}
...
%{ n°11 %}
\pieceTocTitle "Air pour la suite de Melpomène"
\includeScore "AAKair"
%{ n°12 %}

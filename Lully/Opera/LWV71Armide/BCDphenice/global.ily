...
\origVersion {
  \bar "|." s2.*16 \endMark\markup\fontsize #-2 {
    On reprend deux fois le Chœur du Rondeau.
  } \bar "|."
  s2.*16 \endMark\markup \override #'(baseline-skip . 3) \column\fontsize #-2 {
...
\modVersion {
  s2.*16
  \beginMark\markup\fontsize #-2 \italic {
  ...
  \bar ".|:" s2.*8 \bar ":|."
  \endMark\markup \override #'(baseline-skip . 3) \right-column\fontsize #-2 {

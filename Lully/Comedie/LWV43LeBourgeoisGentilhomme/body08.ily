...
\markuplist \columns {
  ...
  \texte {
    ...
    tout à propos. Mon mari vient ; prenez vite votre temps
    pour lui demander Lucile en mariage.
  }
  \personnage "Cléonte."
  \texte {
    Ah ! Madame, que cette parole m'est douce, et qu'elle
    flatte mes desirs ! Pouvais-je recevoir un ordre plus
    charmant ? Une faveur plus précieuse ?
  }
}
...
\markuplist \columns {
  ...
  \personnage "Madame Jourdain."
  \texte {
    Cléonte, ne perdez point courage encore. Suivez-moi,

<<
  ...
  \new Voice {
    ...
    si4  ~ si16 si mi'8  ~ mi'8. [ \scaleDurations #'(2 . 3) { re'32 dod' re' ] } re'8. -\prall dod'16  |
    ...
    lad lad si8  ~ si16  \clef "soprano/treble" lad' si' dod''  \appoggiatura dod''8  \oneVoice \slurDown re''8. (-\mordent \scaleDurations #'(2 . 3) { dod''32 re'' mi''   } mi''8.  -\prall re''32 mi'' )| \slurNeutral
    ...
    mi''16 fad'' mi'' re'' dod'' si' la' sold' fad'8.-\prall \scaleDurations #'(2 . 3) { sold'32 fad' sold'  } \voiceOne \appoggiatura sold'8  \voiceOne la'8. si'16  |
  ...
  \new Voice {
    ...
    < fad la >8. \scaleDurations #'(2 . 3) { la32 [ sold fad ] } fad8.-\markup \finger "3-2"-\mordent fad16  ~ fad fad sold8 s4  |
    ...
    \appoggiatura si8 dod'8. [ \scaleDurations #'(2 . 3) { red'32 dod' red' ] } r16 si lad8 r si  ~ si16 lad  ~ lad8  |

...
re'' si' mi'' ~|
mi'' do'' fa'' ~|
fa'' mi''8\trill re'' mi''4 ~|
mi''8 fa'' re''4.\trill do''8 |
do''2
<<
  \tag #'(violon1 flute1 violons flutes) \new Voice {
    \tag #'(violons flutes) \voiceOne
    mi''4 |
    mi''( re''\prall) fa'' |
    fa''( mi''\prall) mi'' |
    la'' si''8 do''' si'' la'' |
  }
  \tag #'(violon2 flute2 violons flutes) \new Voice {
    \tag #'(violons flutes) \voiceTwo
    do''4 |
    do''( si'\prall) re'' |
    re''( do''\prall) do'' |
    do'' re''8 mi'' re'' do'' |
...
<<
  \tag #'(violon1 violon2 violons) {
    << \tag #'violon1 mi''4 \tag #'violon2 si' \tag #'violons << mi'' \\ si' >> >> la'2 |
    mi''4 la'2 |
    mi'4
  }
  \tag #'(flute1 flutes) \new Voice {
    \tag #'flutes \voiceOne
    sold''4\trill la''8 si'' do''' la'' |
    si''4 do'''8 si'' do''' la'' |
    si''4
  }
  \tag #'(flute2 flutes) \new Voice {
    \tag #'flutes \voiceTwo
    si'4\trill la''8 sold'' la'' fad'' |

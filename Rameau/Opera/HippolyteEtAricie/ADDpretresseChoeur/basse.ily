\clef "basse" sol,2 |
\clef "alto" r4 re'8 re' |
fad' fad' sol' sol |
si si \clef "basse" re re |
...
re4 r8 re |
sol si16 la sol fad mi sol |
la8 dod'16 si la sol fad la |
si4. dod'16 re' |
la4 la, |
re8 dod16 si, la, sol, fad, mi, |
re,8. re'16_"doux" re'8 do' |
si\trill si16 do' la8\trill la16 re' |
sol4 r8 r16 sol_\markup\whiteout "fort" |
la8. la16 la8 la |

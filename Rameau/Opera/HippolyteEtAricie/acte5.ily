...
%{ n°2 %}
\pieceToc\markup\wordwrap { Aricie : \italic { Quels doux Concerts } }
...
%{ n°4 %}
\pieceToc\markup\wordwrap { Aricie, Chœur, : \italic { Ciel ! Diane ! } }
\includeScore "EBBaricieChoeur"
%{ n°5 %}\newBookPart #'(full-rehearsal)
\pieceToc\markup\wordwrap { Diane :
  \italic { Peuples toûjours soûmis à mon obéïssance } }
\includeScore "EBCdiane"
%{ n°6 %}
\scene "Scène III" "SCÈNE 3 : Diane, Aricie"
\sceneDescription\markup\wordwrap-center { \smallCaps Diane seule. }
\pieceToc\markup\wordwrap { Diane :
  \italic { Et vous, Troupe à ma voix fidelle } }
...
%{ n°9 %}
\pieceToc\markup\wordwrap { Diane :
  \italic { Tendres Amans, vos malheurs sont finis } }
...
\pieceToc\markup\wordwrap { Chœur : \italic { Chantons sur la Musette } }
\includeScore "EEAmarcheChoeur"
%{ n°11 %}\newBookPart #'(full-rehearsal)
\pieceTocTitle "Rondeau"
\includeScore "EEBrondeau"
%{ n°12 %}\newBookPart #'(full-rehearsal)
\pieceToc\markup\wordwrap { Une bergère :
  \italic { Plaisirs, doux vainqueurs } }
...
%{ n°18 %}\newBookPart #'(full-rehearsal)
\pieceToc\markup\wordwrap { Aricie ou une bergère :
  \italic { Rossignols amoureux } }

<<
  ...
  \tag #'(oenone basse) {
    ...
    \appoggiatura la' \circA sib' sib' r fa' fad' fad'16 fad' sol'8 la'16 sib' |
    la'4\trill r8 re''16 re'' \appoggiatura do''8 sib'4 sib'16 r r mib'' |
    do''4\arcTrill r8 r16 fa'' fa''8 fa'' mib'' re'' |
    \appoggiatura re'' \circA mib'' mib'' sol' sol'16 la' sib' sib' sib' do'' |
  ...
  \tag #'(thesee basse) {
    ...
    \tag #'basse \theseeMark
    \once\override TextScript #'padding = #3
    \circA do'4-\tag #'thesee ^\markup\italic { à part }
    \cesureCenter r8 la16 do' |
    fa2 la4 la8 la |

...
%# Quoi ? Prince...
\livretPers\line { HIPPOLYTE }
%# \transparent { Quoi ? Prince... } A votre fils je tiendrai lieu de Perre ;
...
\livretPers\line { PHEDRE }
%# \italic { à Hippolyte } \hspace #13 \italic { à part }
...
%# Grands Dieux !
\livretPers\line { PHEDRE }
%# \transparent { Grands Dieux ! } Tu balances encore !
...
%# Donne...
\livretPers\line { HIPPOLYTE }
%# \transparent { Donne... } Que faites-vous ?
\livretPers\line { PHEDRE }
%# \transparent { Donne... Que faites-vous ? } Tu m'arraches ce fer,
...
%# Mon pere !
\livretPers\line { PHEDRE }
%# \transparent { Mon pere ! } Mon époux.
\livretPers\line { THESÉE, \italic { à part } }
%# \transparent { Mon pere ! Mon époux. } O trop fatal Oracle !
%# Je trouve les malheurs que ma prédits l'Enfer.
\livretDidasP\line { à Phedre. }
%# Reine, dévoilez-moi ce funeste mystére.
\livretPers\line { PHEDRE, \italic { à Thesée } }
...
\livretPers\line { THESÉE, \italic { à Hippolyte } }
%# Sur qui doit tomber ma colere ?
%# Parlez, mon fils, parlez, nommez le criminel.
\livretPers\line { HIPPOLYTE }
%# Seigneur... Dieux ! \italic { (à part) } Que vais-je lui dire ?
%# \italic { (à Thesée) } Permettez que je me retire ;
...
\livretPers\line { THESÉE }
%# \italic { (à part) } Quoi ? Tout me fuit ! Tout m'abandonne !
%# Mon épouse ! Mon fils ! Ciel ! \italic { (à Œnone) } demeurez, Œnone.
%# C'est à vous seule à m'éclairer
%# Sur la trahison la plus noire.
\livretPers\line { ŒNONE }
%# \italic { (à part) } Ah ! Sauvons de la reine & les jours & la gloire.
%# \italic { (à Thesée) } Un desespoir affreux... pouvez-vous l'ignorer ?
...
%# Dieux ! Acheve.
\livretPers\line { ŒNONE }
%# \transparent { Dieux ! Acheve. } Un amour funeste...
\livretPers\line { THESÉE }
...
\livretRef #'CFCthesee
\livretDidasP\line { La mer s'agite. }

\clef "dessus" r4 r2 R1 R2. R1 R1 R2.*2 R1 R1*4 R2. R1*2 R2. R1
R2.*2 R1*2 R2.*2 R1*2 R2. R1 R1*2 r4 r r2 R2. R1 R1 R1*2
R2. R1*2 R2. R1 << \origVersion { r4 r r } \modVersion R2. >> R1 R2. R1
r4 r
<< \tag #'violon1 { <mi' dod''>4_\markup\whiteout "un peu doux" | <re' sib'>2 }
  \tag #'violon2 { <sol' la'>4_\markup\whiteout "un peu doux" | <fa' sib'>2 } >> r4 |
R1*2 R1*3 R2. R1 R1

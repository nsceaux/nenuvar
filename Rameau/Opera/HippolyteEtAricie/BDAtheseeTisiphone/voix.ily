<<
  ...
  \tag #'(thesee basse) {
    ...
    sol2.\trill sol8 la |
    fa2 la ~|
    la4 la8 sib fad4\trill ~ fad16 fad fad sol |
    sol2 r4 sib8 do' |
    ...
    \tag #'basse \theseeMark re'4.-\tag #'thesee ^\markup\character "Thésée" re'8 |
  ...
  \tag #'(tisiphone basse) {
    << \tag #'basse { s1*11 s2. s1*7 s2. }
      \tag #'tisiphone { \clef "vbasse" R1*11 R2. R1*7 | r2 r4 } >>
    \tag #'basse \tisiphoneMark sib4-\tag #'tisiphone ^\markup\character "Tisiphone" |
    re'2 r8 re' re' sib |
    fa'4. fa'8 sib4 sib8 sib16 la |
    la2\trill
    \tag #'tisiphone { r2 R1*6 }
  }
>>

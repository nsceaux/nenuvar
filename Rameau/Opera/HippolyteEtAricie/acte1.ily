...
\scene "Scène III" \markup \wordwrap {
  SCÈNE III : Hippolyte, Aricie, la grande prêtresse de Diane, prêtresses de Diane
}
...
\pieceToc \markup \wordwrap {
  Chœur de prêtresses :
  \italic { Dans ce paisible séjour Règne l'aimable innocence }
}
\includeScore "ACBchoeur"
%{ n°9 %}
\pieceTocAndTitle \markup "PREMIER AIR" \markup \wordwrap { Premier air : \italic { Dieu d’Amour, pour nos asiles, tes tourments ne sont pas faits. } }
...
\scene "Scène IV" \markup \wordwrap {
  SCÈNE IV : Phèdre, Œnone, gardes et les acteurs de la scène précédente
}
...
\scene "Scène V" \markup \wordwrap {
  SCÈNE V : Diane et les acteurs de la scène précédente
}
...
%%
%{ n°17 %}\newBookPart #'(full)
\scene "Scène VI" "SCÈNE VI : Phèdre"

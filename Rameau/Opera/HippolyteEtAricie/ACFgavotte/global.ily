<<
  { \keys re \major
    ...
    \partial 2
    s2 s1*3 s2 \origVersion\bar "|;|" \modVersion\bar ":|."
    s2 s1*5 s2 \origVersion\bar "|;|" \modVersion\bar ":|."
    \digitTime \time 2/2
    s2 s1*19 s2 \bar "|."
    ...
    s2 s1*3 s2 \origVersion\bar "|;|" \modVersion\bar ":|."
    s2 s1*7 s2 \origVersion\bar "|;|" \modVersion\bar ":|."
    \digitTime \time 2/2
    s2 s1*23 s2 \bar "|."
    \endMark\markup { On reprend la \concat { P \super re } gavotte }
  }
  \origLayout {

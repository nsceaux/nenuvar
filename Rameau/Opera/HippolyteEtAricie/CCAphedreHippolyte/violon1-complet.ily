\clef "dessus" r2. R1 R2. R1 R1 R2.*2 R1 R1*4 R2. R1*2 R2. R1
R2.*2 R1*2 R2.*2 R1*2 R2. R1 R1*2 r4 r2. R2. R1 R1 R1*2
R2. R1*2 R2. R1 R2. R1 R2. R1
r4 r <mi' dod''>_"un peu doux" |
<re' sib'>2 r4 |
R1*2 R1*3 R2. R1 R1
r4 r8 do'' do''8. do''16 la'8. fa'16 |
do''4 r16 do''-"doux" re'' mi'' fa'' sol'' la'' r r4 |
...
mi'' do'' re'' mi'' fa'' sol'' la'' si'' do'''8 r r4 |

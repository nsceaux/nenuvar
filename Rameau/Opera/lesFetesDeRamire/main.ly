...
\bookpart {
  ...
  \header {
    ...
    notes = \markup \column {
      ...
      \with-url #"http://www.bibliotheques.versailles.fr/simclient/Integration/DOSSIERSDOCS_VERSAILLES/DossiersDoc/voirDossManuscrit.asp?INSTANCE=DOSSIERSDOCS_VERSAILLES&DOSS=BKDD_BMVMsmus_000021_MSMUS131"
      \Typewriter "http://www.bibliotheques.versailles.fr"
    }
  }
  \markup \null
  \pageBreak
...
} \includeScore "CAguerrier" \includeScore "CBchoeur"
%{ n° %}

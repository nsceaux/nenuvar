...
#`((dessus "" () (#:notes "dessus" #:tag-notes dessus))
   ...
   (flute1 "Flûte I" ((dessus #f) (dessus1 #f) (violon1 "Violons"))
           (#:notes "dessus" #:tag-notes flute1))
   (flute2 "Flûte II" ((dessus #f) (dessus2 #f) (violon2 "Violons"))
           (#:notes "dessus" #:tag-notes flute2))
   (hautbois1 "Hautbois I" ((dessus #f) (dessus1 #f) (violon1 "Violons"))
              (#:notes "dessus" #:tag-notes hautbois1))
   (hautbois2 "Hautbois II" ((dessus #f) (dessus2 #f) (violon2 "Violons"))

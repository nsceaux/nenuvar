<<
  ...
  \tag #'(daphnis basse) {
    <<
      \tag #'basse { s2. s1*3 s2. s4 \daphnisMark }
      \tag #'daphnis { \clef "vhaute-contre" R2. R1*3 R2. | r4 }
    >>
    dod'8 dod' dod'4 red'8 mi' |
    red'4\trill fad'8. sol'16 fad'4( mi'8)\trill mi'16 red' |
    \appoggiatura red'8 mi'4\prall
    \tag #'daphnis { r4 r | R1*5 | r4 r }
  }
>>
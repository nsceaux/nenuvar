...
\tag #'(dessus1 dessus2) <>^"Violons"
<<
  \tag #'(violon1 dessus1) { \afterGrace fad''2.( mi''8) | mi''4 r r | }
...
<<
  \tag #'(violon1 hautbois1 hautbois2 dessus1 dessus2) \new Voice {
    \tag #'dessus1 <>^"Tous"
    \tag #'dessus2 { \voiceOne <>^\markup\whiteout Hautbois }
    la'4 re''2 | re''2( do''8) r |
  }
  \tag #'(violon2 dessus2) \new Voice {
    \tag #'dessus2 { \voiceTwo <>_\markup\whiteout Violons }

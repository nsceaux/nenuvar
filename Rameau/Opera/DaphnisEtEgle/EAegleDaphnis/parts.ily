\piecePartSpecs #`((basse
  ...
  \tacet #47
  \bold EGLÉ
  \verse#12 { Daphnis vous n’aimez point comme l’on doit aimer. }
  \bold DAPHNIS
  \verse#8 { Quel soupçon osez-vous former ? }
  \verse#8 { Ce reproche injuste m’accable. }
  \bold EGLÉ
  \verse#8 { Ah puisque le ciel sans pitié }
  \verse#10 { A prononcé qu’un de nous est coupable }
  \verse#8 { D’être infidèle à l’amitié, }
  \verse#12 { Lorsque pour vous la mienne est si vive et si tendre }
  \verse#8 { Quoi ? ce dieu que vous offensez }
  \verse#8 { Ne fait-il pas assez entendre }
  \verse#8 { Que c’est vous qui le trahissez. }
  \bold DAPHNIS
  ...
  \bold DAPHNIS
  \verse#12 { C’est ce bien qui fait seul le bonheur de ma vie. }
} #}))

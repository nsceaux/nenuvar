...
<<
  \tag #'(violon1 hautbois1) {
    \origVersion {
      \tag #'violon1 <>^\markup { \concat { p \super rs } viol[ons] }
      \tag #'hautbois1 <>^\markup { h[aut]bois, et muzettes }
    }
    si''4 la'' |
  ...
  \tag #'(violon2 hautbois2) {
    \origVersion <>^\markup\concat { 2 \super es }
    \tag #'violon2 \slurDashed sold''4( fad'') |
    fad''\trill( mi'') mi''\trill( red'') |
    \tag #'violon2 \slurSolid red''4.(\trill dod''16 red'') mi''4 si' |
    si'( la') \tag #'violon2 \slurDashed la'( fad') |
...
<<
  \tag #'violon1 {
    <>^\markup { \concat { p \super rs } viol[ons] } _\ademi
    sold'4( dod'') |
    ...
    sold''4 r \cesureInstr <>\doux sold'' dod'' |
    dod''2( sid'4)\trill dod'' |
    fad''2. sid'4 |
    dod''2 sid'4\trill dod'' |
    sold'2 \cesureInstr <>\ademi red''4 mi'' |
  ...
  \tag #'hautbois2 {
    \noHaraKiri r2 |
    R1*7 |
    r2 \revertNoHaraKiri <>^\markup\whiteout "h[aut]b[ois]" sid'4 dod'' |
...
<<
  \tag #'(hautbois1 hautbois2) {
    ...
    \tag #'hautbois1 \footnoteHere #'(0 . 0) \markup\column {
      \justify {
  ...
  \tag #'violon1 {
    ...
    fad''2 mi''8 red'' dod'' si' |
    lad'2\trill si' |
    fad'2 \clef "dessus2" fad''4(\ademi red''8) r |
  ...
  \tag #'violon2 {
    ...
    %{
    <>^\markup { \concat { 2 \super es } viol[ons] partagez en deux }
    <<
      { dod''4( mi'') |
        mi''2( red''8) r fad''( si') |
        si'2( dod''8)\prall r mi''( lad') |

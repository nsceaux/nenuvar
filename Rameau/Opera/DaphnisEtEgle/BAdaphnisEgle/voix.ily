<<
  ...
  \tag #'(egle basse) {
    <<
      \tag #'basse { s2. s1*2 s2.*2 s1*2 | s4 \egleMark }
    ...
    sol'1 |
    <<
      \tag #'basse { s1 s2.*9 s1 s2. s1*3 s2. s4. \egleMark }
    ...
    \appoggiatura re''8 do'' fa'' fa''4( fa''16[\trill mib'']) re'' mib'' |
    re''2\trill re''8 r |
  ...
  %% Daphnis
  \tag #'(daphnis basse) {
    \tag #'basse \daphnisMark
    \clef "vhaute-contre"
    r4 r r8 sol' |
    re'4 r8 mib' re'4( do'8)\prall sib16 la |
    \appoggiatura la8 sib2. sib4 |
    \appoggiatura sib8 do'4\prall do'8 do'16 do' fa'8. fa'16 |
    re'4\trill re'8 r16 sol' la'8. re''16 |
    mi'2 mi'4 fad'8 sol' |
    ...
    <<
      ...
      \tag #'daphnis {
        ...
        la2\trill la8 r re'4 |
        re'8.([ mib'16])\trill mi'8 mi'16 mi' fad'8. sol'16 |
        sol'2~ sol'4.( fad'8) |

...
re'' la'16 sol' fad' mi' re'4 <<
  \tag #'(conducteur hautbois1) { la'8 | si'4 si'8 la'4 sol'8 | }
  \tag #'(conducteur hautbois2) { fad'8 | sol'4 sol'8 fad'4 mi'8 | }
>> <<
  \tag #'(conducteur hautbois1) \new Voice {
    \tag #'conducteur \voiceOne
    fad'8 la'16 sol' fad' mi'
  }
  \tag #'(conducteur hautbois2) \new Voice {
...
<<
  ...
  \tag #'(conducteur hautbois2) {
    sold'8 |
    sold'4 la'8 la'4 si'8 |
    si'4 la'8 sold'4 dod''8 |
...
>> mi'16 re' dod' si la8 r %{%} <<
  \tag #'(conducteur hautbois1) {
    ...
    dod''8. re''16 si'8 s4 mi''8 |
    mi''4 mi''8 mi''4 s8 |
    s8. mi''16 fad''8 s4 mi''8 |
  ...
  \tag #'(conducteur hautbois2) {
    ...
    la'8. si'16 sold'8 s4 dod''8 |
    dod''4 dod''8 dod''4 s8 |
    s8. dod''16 re''8 s4 dod''8 |
    dod''4 re''8 re''4 mi''8 |
    mi''4 re''8 dod''4 fad''8 |
    fad''8. mi''16 re''8 dod''8. la'16 sol'8 |
    fad'4.
  }
  { s8 | s2.*3 | s4. la'8 r s | s4. s4 re''8 | re''8. s8. dod''4 s8 | }
>>
re'''4. |
re'' re''' |
re'' r4
...
la'16 sol' fad' mi' re'8 r8 <<
  \tag #'(conducteur hautbois1) { \custosNote mi''8 | re''8 }
  \tag #'(conducteur hautbois2) { \custosNote dod''8 | fad'8 }
>>

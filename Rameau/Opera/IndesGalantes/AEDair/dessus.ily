...
<<
  \setMusic #'h {
    la''8 |
    la''8. si''16 la'' sol'' |
    fad''8\trill \appoggiatura mi''16 re''8
  }
  \setMusic #'vI {
    fad''8 |
    mi'' dod'' mi'' |
  ...
  \tag #'violon << \vI \\ \vII >>
  \tag #'dessus2 <<
    { <>^\markup { \concat { P \super ers } violons } \vI }
    \\ { <>_\markup { \concat { 2 \super ds } violons } \vII } >>
>>
fad''8-\tag #'(dessus dessus1 dessus2) ^"Tous" |
sol''16( la'') la''8.(\trill sol''32 la'') |
si''4
<<
  \setMusic #'hI {
     sol''8 |
    \appoggiatura fad''16 mi''8 la''4 |
    red''8\trill si'
  }
  \setMusic #'hII {
    si'8 |
  ...
  \tag #'hautbois1 \hI
  \tag #'hautbois2 \hII
  \tag #'dessus1 { <>^"Hautbois" \hI }
  \tag #'dessus2 { <>^"Hautbois" \hII }
  \tag #'(violon1 flute1) <<
...
<<
  ...
  \tag #'dessus1 << r16^"Hautbois" { \AhI \Bh } >>
  \tag #'dessus2 << r16^"Hautbois" { \AhII << { s4. s^"Violons" } \Bv >> } >>
...
>>
re'''8_\fort -\tag #'(dessus dessus1 dessus2) ^"Tous" |
si''\trill la'' re''' |

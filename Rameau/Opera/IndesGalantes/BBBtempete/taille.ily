\clef "taille" \ru#4 sib8 \ru#8 sib16 |
\ru#8 sib16 \ru#16 sib32 |
\ru#16 sib32 \ru#16 re'32 |
\ru#16 re'32 \ru#16 fa32 |
\ru#32 sib'32 |
sib'8 r r4 r2 |
r32 fa fa fa fa fa fa fa \ru#8 fa32 fa8 r r4 |
...
\ru#32 fa'32 |
\ru#8 sol'32 \ru#8 sib32 sib4 r8 r32 fa fa fa |
fa8 r r4 \ru#8 sol16 |
\setMusic #'reprise {
...
\tag #'() \reprise
sol'32 sib' la' sol' fa' mib' re' do' sib8 r r2 |
r32 do' do' do' do' do' do' do' \ru#8 do'32 \ru#8 sib32 |
la32 fa sol la sib do' re' mi' fa'8. re'16 re'4 r8 r32 mi' mi' mi' |
mi'4 re' re' la |
la32 re' mi' fad' sol' la' sib' do'' \ru#24 re''32 |

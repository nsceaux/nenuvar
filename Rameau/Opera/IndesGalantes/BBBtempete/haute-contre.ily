...
\tag #'() \reprise
sib'32 re'' do'' sib' la' sol' fa' mib' re'8 r r2 |
r32 do' do' do' do' do' do' do' \ru#8 do'32 re'32 re' re' re' re' re' re' do' |
do' fa sol la sib do' re' mi' fa'8. la'16 sib'4 r8 r32 sib' sib' sib' |
mi'4 la'4. sol'8 sol' mi' |

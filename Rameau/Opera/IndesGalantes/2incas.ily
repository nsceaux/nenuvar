...
\pieceToc \markup { Phani : \italic { Viens, hymen, viens m'unir au vainqueur que j'adore ! } }
...
%{ n°19 %}\newBookPart #'(full)
\pieceToc \markup { Phani, Carlos, Huascar : \italic { Pour jamais, l'amour nous engage. } }

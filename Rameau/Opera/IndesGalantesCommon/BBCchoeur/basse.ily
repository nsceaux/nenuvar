\clef "basse"
\tag #'basson sol4^\markup { \mod-version Bassons }
\tag #'basse sol,
\tag #'conducteur << sol^"[Bassons]" \\ sol,_"[Basses]" >>
r4 r2 r2 |
R1. |
...
<<
  \setMusic #'basson {
    ...
    fad8\trill re, re, re, re, re, re,4 re, re, |
  }
  \setMusic #'basse {
    r2 \new CueVoice r4 |
    R1. |
...
sol2 sol4 sol sol mi |
la16 la, la, la, \ru#8 la, la,4 la fa |
sib2. sol2 la4 |
re2.
<<
  \setMusic #'basson {
...
si,4 \ru#16 si,32 |
si,8 r do4 re |
mib32 do, do, do, do, do, do, do, \ru#8 do, do,8 r |
r4 do re |
sol, r \ru#8 si,32 r4 |
\ru#8 do32 r4 \ru#8 re32 re8. mib32*2/3 re do |
sib,4~ sib,8. do32*2/3 sib, la, sol,8. lab,32*2/3 sol, fa, mib,4 |

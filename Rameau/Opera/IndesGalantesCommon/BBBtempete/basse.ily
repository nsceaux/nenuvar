...
<<
  \setMusic #'basse {
    ...
    \ru#16 sol,16 |
    \ru#16 la,16 |
    \ru#4 sib,16 \ru#2 sib,16 \vA\ru#2 si,16 \vB { si,?16 si, }
    ...
    sol,4 r
    \vA \ru#16 sol,32
    \vB { <>-\fort << \ru#16 sol32 \\ \ru#16 sol,32 >> } |
  }
  \setMusic #'basson {
    ...
    sib, fa sib, fa sib, sol \vA si, \vB si,? sol do sol do sol do la dod la |
    ...
    sol4 r \vB <>-\fort \ru#16 sol32 |
  }
  \tag #'basson \basson
  \tag #'basse \basse
  \tag #'conducteur << \basson \\ \basse >>
>>
sol16 sib la sol fa mib re do sib,8 r \vA { r16 sib,16 do sib, } \vB r4 |

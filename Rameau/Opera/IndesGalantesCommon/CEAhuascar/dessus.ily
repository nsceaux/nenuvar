...
r8 do''\doux do''2~ |
\setMusic #'reprise {
  do''4 re''8. mi''16 mi''4( re''16)\trill do''( si') re'' |
  sold'2\trill r4 |
  r4 r mi''4 |
  ...
  <<
    ...
    \new Voice {
      \voiceTwo
      si'4 do''8. re''16 \appoggiatura do''8 si'\trill la'16( sold') |
      \appoggiatura sold'?8 la'4 re''8.( do''16) do''4( si'16\trill) r si'( do'') |
...
\appoggiatura si'8 do''4 sol'8 sol'16 la'
sol'4.( fa'32[\trill mi']) fa'16 |
mi'2\trillSug fad'8. sold'16 |

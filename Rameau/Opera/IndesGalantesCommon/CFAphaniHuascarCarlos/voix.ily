  ...
  \tag #'(phani basse) {
    ...
    \vA {
      ...
      <<
        ...
        \tag #'phani {
          r8 r4 | R1*3 | r1 r2 | R1.*27 | R1*2 R2. | r2
        }
      >> \tag #'basse \phaniMark
      r4 mib'' |
      sol''4. do''8 re'' mib'' |
...
%%
  ...
  \tag #'(carlos basse) {
    ...
    re'4\trill r8 mib'16 mib' do'8 do'16 re' |
    \appoggiatura do'8 sib4 sib8 r re'16 re' mi' fa' mi'8 fa'16 sol' |
    do'8\trill do'16 reb' sib4\trill sib8 lab16 sol |
    lab8 lab r16 fa' sol' lab' re'8\trill re'16 mib' |
    fa'2 fa'8 r r4 |
    r2 re'4 re'8 re' |
    sol'8. sol'16 re'8 re'16 re' si8 si16 re' |
    sol4 do'8 do'16 re' mib'8 do' |
    fa'4 fa'8 fa'16 fa' mib'8.\trill re'16 |
    mib'8. mib'16 mib'4 re'8 do'16 sib |
    la4\trill la8 la16 la re'8. re'16 |
    si4 si8 r r4 |
    \vA R2.*2 |
    r4 sol'8 sol' do'4 do'8 sol |
    lab4 lab8 lab sol4\trill sol8 lab |
    fa4 sib sib16 sib do' reb' |
    do'8 do'16 re' mib'4. mib'16 re' |
    \vA { mib2 r4 sib8 sib }
    \vB { mib'2 r | r2 r4 sib8 sib | }
    si si16 si si do' re'8 re' re'16 re' |
    sol2 sol8 sol' sol' fa' |
    mib'4 mib'8 mib' mib'4 mib'8 sol' |
    do'8 do'16 r do'8 sib sib4. sib16 la |
    \vA {
      la2 r |
      <>^\markup \italic "[à Huascar]"
      fad'4. fad'16 la' re'8. re'16 re' re' re' la |
    }
    \vB {
      la2 fad'4.^\markup \italic "[à Huascar]" fad'16 la' |
      re'4. re'8 re' re' re' la |
    }
    sib8 sib \vA r4 r8 sib16^\markup \italic "[à Phani]" sib mib'8 mib'16 mib' |
    do'4\trill do'8 do'16 do' re'8 mib' |
    re'4\trill r8 sol' \appoggiatura fa'8 mi'4 mi'8 fad'16 sol' |
    fad'4
    \tag #'carlos { r4 r2 R1 r2 }
  }
  %% Huascar
  \tag #'(huascar basse) {
    \clef "vbasse"
    ...
    <<
      { s4. s1*4 s2.*2 s4 }
      \tag #'huascar { r8 r4 | R1*4 R2.*2 | r4 }
    >> \tag #'basse \huascarMark
    mi8 mi la4 la8 mi |
    sol4 sol8 sol sol fa16 mi |
    fa4. sib8 sib8. sol16 do'8. do'16 |
    la4\trill re'8 re' si4 dod'8 re' |
    dod'2 dod'8 r r4 |
    ...
    <<
      { s2. s1*2 s2.*2 s1 s2.*2 s1*2 s2.*6 \vA s2.*2 s1*2 s2.*2 s1 \vB s1
        s2. s1*5 \vA s1 \vB s2. s2. s1 s4 }
      \tag #'huascar {
        R2. R1*2 R2.*2 R1 R2.*2 R1*2 R2.*6 \vA R2.*2 R1*2 R2.*2 R1 \vB R1
        R2. R1*5 \vA R1 \vB R2. R2. R1 | r4
      }
    >> \tag #'basse \huascarMark
    re'4 r8 sib sol8 sol16 fad |
    sol2 r |
    r
  }
>>

...
%%
    ...
    \tag #'phani {
      r8 r4 r4 | R2. R1 R2.*2 R1*2 R2.*6 R1*2 R2.*2 R1*2
  ...
  \tag #'(carlos basse) {
    ...
    sib8 sib r8 sib16^\markup \italic "[à Phani]" sib mib'8 mib'16 mib' |
  ...
  \tag #'(huascar basse) {
    ...
    <<
      { s2. s1*2 s2.*2 s1 s2.*2 s1*2 s2.*6 s1*2 s2.*2 s1*2
        s2. s1*5 s2.*2 s1 s4 }
      \tag #'huascar {
        R2. R1*2 R2.*2 R1 R2.*2 R1*2 R2.*6 R1*2 R2.*2 R1*2
        R2. R1*5 R2.*2 R1 | r4
      }
    >> \tag #'basse \huascarMark

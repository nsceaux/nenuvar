\clef "vdessus" re'8^\markup\orig-version\character Chœur re' |
...
sol''[\melisma fad'' sol'' la'' sol'' fad''] |
mi''[ red'' mi'' fad'' red'' mi''] |
fad''[ mi'' fad'' sol'' mi'' fad'']( |
red''4.)\trill\melismaEnd red''8 red'' fad'' |
si'2. |
si'4 mi''8 re'' do'' si' |
la' sol' fad'2\trill |
mi'2. |
...
<<
  ...
  \new Voice = "two" \with { autoBeaming = ##f } {
    ...
    si'2. | } >>
\oneVoice r4 r r8 re'' |
mi''[\melisma re'' mi'' fa'' mi'' re''16\trill do''] |

<<
  ...
  \tag #'(amour basse) {
    ...
    si'4\trill r16 sol'' sol'' sol''
    \vA { mi''4\trill mi''8 si'16 mi'' }
    \vB { mi''8\trill mi'' si' mi'' } |
    dod''8\trill dod'' r16 la' la' la' re''8 mi''16 fad'' mi''8\trill mi''16 fad'' |
    \vA\appoggiatura mi''8 re''2.
    \tag #'amour { \vA R2.*17 \vB R2.*18 r4 r }
  }
  %% Hebé
  \tag #'(hebe basse) {
    <<
      \tag #'basse { s1 s2. s1*4 s2. }
      \tag #'hebe { \clef "vbas-dessus" R1 R2. R1*4 R2. }
    >>
    \hebeMark si'4 do'' re'' |
    la'2~ la'8 si' |
    fad'2-\vA\trill sol'4 |

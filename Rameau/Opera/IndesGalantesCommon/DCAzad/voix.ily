<<
  ...
  \tag #'(zima zima-violons voix1 basse) {
      ...
      \tag #'zima-violons { r4 r2 R1*6 R2.*7 r4 r }
      {
        ...
        <<
          ...
          \tag #'(zima basse voix1) {
            ...
            si'4 do''8 re''16 mib'' re''8[\prall do''16] re'' |
    ...
    <<
      ...
      \tag #'(zima voix1 zima-violons) {
        ...
        re''2\trill r8 sol'' |
        sol''4. \appoggiatura fa''8 mi''8 do'' fa'' |
        fa''2( mi''4) |
        fa''2. |
        do''4. do''8 re'' mib'' |
        re''4.( do''8)\prall re'' sib' |
        do''4 la'\trill fa'8 fa' |
        sib'4 lab'( sol'8) lab' |
        sol'2\trill do''8 mib'' |
        re''4.( do''8)\prall re''8 \appoggiatura do'' sib' |
        la'2\trill sol'8 fa' |
        sib'4.( la'8)\prall sib'4 |
        \appoggiatura sib'8 do''2. |
        r4 r fa''8 mib'' |
        \appoggiatura mib''8 re''2\trill do''8 re'' |
        \appoggiatura do''8 sib'2 mib''8 re'' |
        re''4.( do''8)\prall sib' do'' |
        re''2 \appoggiatura do''8 sib'4 |
        sol'2 la'8 sib' |
        fa'4 sol' la'8 fa' |
        sib'2 mib''4 |
        do''2.\trill |
  ...
  \tag #'(damon basse voix1 voix2) {
    ...
    \tag #'(damon basse voix2) {
      fa'16 fa' fa'8 fa'16 re' sol'8 mib'16 mib' do'8 re'16 mib' |
      re'2 re'8 r r4 |
    }
  }
  %% Alvar
  \tag #'(alvar basse voix1 voix2) {
    ...
    \tag #'(alvar voix2 basse) {
      ...
      mi4\trill mi8 r16 la sol8 sol16 fa mi8 mi16 fa |
      re8

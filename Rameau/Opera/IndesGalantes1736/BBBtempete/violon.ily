\clef "dessus2" sib8 sib sib sib sib16 sib sib sib sib sib sib sib |
sib16*4/6 sib sib sib sib sib sib sib sib sib sib sib
sib32 sib sib sib sib sib sib sib \ru#8 sib32 |
\ru#8 <re' sib>32 \ru#8 <re' sib>32 \ru#8 <fa' sib> \ru#8 <fa' sib> |
\clef "dessus" \ru#8 <sib' fa'> \ru#8 <sib' fa'> \ru#8 <re'' fa'> \ru#8 <re'' fa'> |
\ru#8 <fa'' re''> \ru#8 <fa'' re''> \ru#8 <sib'' re''> \ru#8 <sib'' re''> |
<sib'' re''>8 r8 r4 r2 |
r32 sib'' la'' sol'' fa'' mib'' re'' do'' sib' sib' la' sol' fa' mib' re' do' sib8 r r4 |
\ru#8 fa'32 \ru#8 fa'32 fa'32 fa' sol' la' sib' do'' re'' mib'' fa''8 r |
\clef "dessus2" r32 sib' la' sol' fa' mib' re' do' sib do' re' mib' fa' sol' lab' fa'
sol' mib' fa' sol' lab' sib' do'' re'' mib''8 r |
r32 do'' sib' la' sol' fa' mi' re' do' re' mi' fa' sol' la' sib' sol'
la' fa' sol' la' sib' do'' re'' mi'' fa''8 r |
\clef "dessus" r32 re'' do'' sib' la' sol' fad' mi' re' mi' fad' sol' la' sib' do'' la'
sib' sol' la' sib' do'' re'' mi'' fad'' sol''8 r |
...
fad''32 re'' mi'' fad'' sol'' la'' sib'' do''' \ru#8 re'''32 \ru#8 re'''32 \ru#8 re'''32 |
re'''8 r r4 \clef "dessus2" sol'16(\doux sib') sol'( sib') sol'( sib') sol'( sib') |
\tag #'() \reprise
\custosNote sib''4
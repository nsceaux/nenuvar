...
do'''4. si''8 la'' sol'' fad'' mi'' |
fad''4. sol''8 sol''4.\trill(
\footnoteHere #'(0 . 0) \markup\justify {
  \line {
    A132a, Cons.192 : \score {
      { \tinyQuote \key sol \major \time 2/2 \clef "french"
        fad''4. sol''8 sol''4.\trill( la''16 sol'') | la''2 }
      \layout { \quoteLayout }
    }
    \hspace #1
  }
  \line {
    A132a², Vm²328 : \score {
      { \tinyQuote \key sol \major \time 2/2 \clef "french"
        fad''4. sol''8 sol''4.\trill( fad''16 sol'') | la''2 }
      \layout { \quoteLayout }
    }
  }
} fad''16 sol'') |
...
>> r2 |
R1 |
r4^"Tous" re''8 mi'' fad'' sol'' la'' fad'' |

...
%%%
<<
  \tag #'(dessus1 dessus2) { r8 | R2.*29 | r4 r }
  \tag #'musette1 {
    r8 |
    R2. |
    r4 r r8 sol'\doux |
...
%%%
\tag #'(dessus1 dessus2) {
  \tag #'dessus1 <>^\markup\whiteout { Violons, musettes et hautb[ois] }
  r8 sol' |
  si'2 si'8 si' |
  re''2 re''8 re'' |
  sol''2. |
  ...
  sol' re'8 r si4 |
  do'2 re'4 |
  sol4. \clef "dessus" <>^\markup\whiteout Tous <<
    \tag #'dessus1 {
      re''8 re'' re'' |
      mi''4. re''8 do'' mi'' |
      re''4 \appoggiatura do''8 si'4 sol'\doux |
      sol'2.~ |
      sol'2
    }
    \tag #'dessus2 {
      si'8 si' re'' |
      sol'4. fa'8 mi' do'' |
      si'4\trill \appoggiatura la'8 sol'4 sol'\doux |
      sol'2.~ |
      sol'2
    }
  >> r4 |

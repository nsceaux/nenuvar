...
re'4 fa8 sol la4 la, |
re do8 sib, la, sol, fa, mi, |
re,4 re\doux sib sib8 sol |
re'2 r4 la8 la |
sib4 sib do' do'8 do' |
fa2 r4 fa8 fa |
do'2 sib4 la |
...
re'2 do' |
sib1 |
r4 sib8 la sol fa mi re |
la4 sol8 fa mi re dod si, |
la,4 r r2 |
R1 |
r4 la8 si dod' re' mi' dod' |
...
\footnoteHere #'(0 . 0) \markup {
  Source A134, basses : \score {
    { \tinyQuote \key re \minor \time 2/2 \clef "alto"
      mi'2 mi'4 mi' |
      mi'2. mi'4 |
      \clef "bass" mi'2. mi'4 |
      mi'2. mi8 fad |
...
la1 |
<<
  \new CueVoice { \voiceOne \clef "tenor/tenor" la4 la8 si dod' re' mi' fa' | sol'1 | }
  \new Voice { \voiceTwo R1*2 }
>>
\clef "basse" r2 la, |
dod,2. la8 si |

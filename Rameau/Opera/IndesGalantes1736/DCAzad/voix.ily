<<
  ...
  \tag #'(zima basse) {
    <<
      \tag #'zima {
        \clef "vbas-dessus" r4 r2 | R1*6 R2.*3 | r4 r16
        <>^\markup\character Zima
      }
      \tag #'basse { s2. s1*6 s2.*3 s4 s16 \zimaMark }
    >>
    ...
    \appoggiatura sib'8 do''4 la'\trill fa'8 fa' |
    sib'4 lab'( sol'8) lab' |
    sol'2\trill do''8 mib'' |
    ...
    do''2.\trill |
    fa''2 <sol'' sib''>8 re'' |
    \appoggiatura re''8 mib''4. \appoggiatura re''8 do'' \appoggiatura do'' re''8. mib''16 |
    re''4( do''4.)\trill sib'8 |
    sib'4
    %%
    \tag #'zima { r4 r4 | R2. R1*2 R2.*2 R1*3 }
  }
  %% Damon
  \tag #'(damon basse) {
    <<
      \tag #'damon {
        \clef "vhaute-contre" r4 r2 | R1*6 R2. | r4 r16
        <>^\markup\character Damon
      }
      \tag #'basse { s2. s1*6 s2. s4 s16 \damonMark }
    >>
    re'16 re' re' sol'8 sol' |
    mi'4\trill mi'8 mi'16 mi' fad'8 sol' |
    fad'4\trill fad'16
    <<
      \tag #'damon { r16 r8 r4 | R2.*39 | r4 <>^\markup\character Damon }
      \tag #'basse { s4.. s2.*39 | s4 \damonMark }
    >>
    re'8 re'16 do' sib8\trill la |
    \appoggiatura la sib r16 sib16 do'4 re'8 mib'16 fa' |
    re'4\trill re'8 r sib'2~ |
    sib'4. mi'16 mi' mi'4 fa' |
    <<
      \tag #'damon { fa'2 r4 | R2. R1 r8 }
      \tag #'basse { fa'4 s2 s2. s1 s8 \damonMark }
    >>
  ...
  \tag #'(alvar basse) {
    ...
    <<
      \tag #'alvar {
        r16 r8 r4 | R2.*41 |
        r4 <>^\markup\character Alvar
        sib8 sib16 la sol8\trill fad |
        \appoggiatura fad8 sol r16 fa16 mib4 re8 do16 fa |
        sib,2 sib,8 r r4 |
        sol4. sol16 sol do'4 do' |
        la\trill
      }
      \tag #'basse { s4.. s2.*45 s4 \alvarMark }
    >>
    r8 la16 la re'8 re'16 la |
    \appoggiatura la8 sib8. sib16 sol4\trill sol8 sol16 sol |
    mi4\trill mi8 r16 la sol8\trill sol16 fa mi8\trill mi16 fa |
    \appoggiatura mi8 re8

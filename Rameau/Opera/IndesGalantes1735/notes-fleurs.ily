...
\markuplist\with-line-width-ratio #0.8 \column-lines {
  ...
  \wordwrap {
    ...
    On le reproduit ici, en utilisant les parties ajoutées par Dukas.
  }
  \livretRef #'EELboree
  \livretDescAttPage "AIR DE BORÉE"
  \wordwrap {
    La partie séparée de second violon contient ensuite un air de Borée,
    reproduit en utilisant les parties ajoutée par Dukas.
  }
  \livretRef #'EEMzephir

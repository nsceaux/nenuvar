...
\markuplist\column-lines {
  ...
  \wordwrap {
    Un prélude est ajouté sur une collette :
  }
}
\score {
  \new ChoirStaff <<
    \new Staff {
      ...
      \appoggiatura dod''8 re''4 la'8*2/3 fad'' sol'' la'' sol'' fad'' |
      \origVersion\break
      <<
        { si''4~ si''2~ |
          si''4*2/3 la''8*2/3 sol''( la'') fad'' mi''( fad'') re'' |
          dod''4\trill r8*2/3 fad''\fort sold'' lad'' si'' dod''' |
          re''' dod''' si'' fad''4 lad'' |
          si''2 } \\
        { si''4 r8*2/3 red''\doux mi'' fad'' mi'' red'' |
          mi''4 si'2 |
          fad'4 r8*2/3 lad' si' dod'' re'' mi'' |
    ...
    \new Staff {
      \clef "bass" \key si \minor \digitTime\time 3/4
      <>^"Tous"
      R2. |
      r4 fad^\doux fad, |
      si, r4 si^\fort |
      ...
      re4 r re'^\fort |
      red'\trill r si^\doux |
      \scaleDurations 2/3 { mi4 fad8 sol4.~ sol4 mi8 } |
      fad4 r r8 mi^\fort |

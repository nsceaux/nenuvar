...
<<
  \setMusic #'I {
    re''8 |
    re'' mi'' re'' mi'' fa'' sol'' |
    mi'' fa'' mi'' \vA fad'' \vB fad''? sol'' la'' |
    fad''4-\vA\trill sol'' la'' |
    re'' do'' sib' |
    la'2\trill
  }
  \setMusic #'II {
...
sib'4\trill \appoggiatura { \vA la'8 \vB la'16 } sol'4 r8 sol'' |
sol''2.~ |
sol''~ |
sol''~ |
sol''~ |
...
\vA {
 ...
 r4 r r8 sib' |
 la'2~ la'8 sol'16 fad' |
 sol'4.( la'16 sib') la'8( sol'16\trill fad') |
 sol'4.( la'16 sib') la'8( sib'16 sol') |
 fad'2\trill
}
r8 re'' |

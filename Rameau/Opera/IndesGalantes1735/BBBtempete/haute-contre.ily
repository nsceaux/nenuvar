...
\times 4/6 \ru#6 sib16 \times 4/6 \ru#6 sib16 <<
  \modVersion {
    \ru#16 sib32 |
...
sib8 r r4 <<
  \modVersion \ru#8 re'16
  \origVersion { <>^"doubles croches" re'4 re' }
>>
\setMusic #'reprise {
  ...
  <<
    \modVersion \ru#8 re'16
    \origVersion { <>^"doubles" re'8 re' re' re' }
  >>
...
r32 do' do' do' do' do' do' do' <<
  \modVersion { \ru#8 do'32 \ru#4 re'32 \ru#4 do'32 | }
  \origVersion { <>^"triples c." do'4 re'8 do' | \breathe }
>>
...
re'32 re' mi' fad' sol' la' sib' do'' <<
  \modVersion \ru#24 re''32
  \origVersion { <>^"triples c." re''4 re'' re'' \breathe | }
>>

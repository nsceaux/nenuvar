\markuplist\with-line-width-ratio #0.8 \column-lines {
  ...
  \justify {
    ...
    pour déterminer les pièces qui figuraient originellement, et dans
    quel ordre.
  }
  ...
  \wordwrap {
    Sur la page suivant cette entrée, figure la seconde page
    de la musette en rondeau (cf. page \page-refII #'ABErondeau ),
  ...
  \wordwrap {
    Des notes en fin de pièce indiquent de jouer \italic { la forlane },
    ou \italic { air de violons et musettes },
  ...
  \wordwrap {
    À la fin de la pièce, une indication :
    \italic { “on reprend l’air des drapeaux entier” } est barrée.
    Un signe de renvoi indique de passer aux vers d’Hebé
    \italic { Pour remplacer les cœurs que vous ravit Bellone }
    (page \page-refII #'AEBamourHebe ).
  }
  ...
  \line { \hspace #20 Rallumez vos flambeaux, remplissez vos carquois, }
  \line { \hspace #20 Moissonnez, méritez les palmes immortelles. }
  \wordwrap {
    \italic “Rallumez” est changé en \italic “Ranimez”,
    et \italic “immortelles” en \italic { “les plus belles”. }
  }
  \null
  ...
  \wordwrap {
    La barre de reprise de la dernière mesure est noircie.
  }
  \wordwrap {
    À la fin de l’air, il est indiqué :
    \italic { contredance pour finir le prologue. }
  }
  ...
  \wordwrap {
    À la fin du prologue, le renvoi à l’ouverture est barré,
    remplacé par l’indication de rejouer les deux menuets

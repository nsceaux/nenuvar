<<
  \new Staff = "up" <<
    ...
    \new Voice = "one" {
      ...
      re''8. fad'16 |
      sol'4.\parc mib''8 re''8. fad'16 |
      sol'4\parc~ sol'32*8/6[ la' sib' do'' re'' mib''] \voiceOne re''8. sol''16 |
      do''4 la'4.\prall re''8 |
      sib'4\prall sol'4\parb sib''4~ |
      sib''4. sib''8 la''4~ |
      la''4. la''8 sol''4~ |
      sol''4. s8 fa''8. mi''16 |
      ...
      \oneVoice sol'8.[ sib'32*2/3 la' sol'] fa'8.\prall mi'16 la'4\para~ |
      ...
      sib'4.\parc sol''8 fa''8. la'16 |
      sib'4\parc~ sib'16 do'' re'' mib'' fa'' sol'' fa'' sib'' |
      mib''4.( re''16\prall do'') re''8.\parc mib''16 |
      do''2\prall fa''8. sib''16 |
      sib''4.( la''16)\prall sol'' sol''8. sib''16 |
      sib''4.( la''16)\prall sol'' fa''8. sib''16 |
      sib''4. la''32*4/5[ sol'' fa'' mib'' re''] <do'' mib''\parc>8. fa''16 |
      ...
      sol'4.\parc mib''8 re''8. fad'16 |
      sol'2\parc \voiceOne sol''8. si'16 |
      do''4.\parc sib''8 la''8. dod''16 |
      re''4.\parc la'8 re''8. fa''16 |
      <mi'' re''>4 mi'' fad''8.\parc sol''16 |
      fad''2.\prall~ |
      fad''\prall |
      sol''2~ sol''8. fa''16 |
      mib''8. re''16 do''4.\prall do''8 |
      do''8. mib''32*2/3 re'' do'' sib'8.\prall la'16 re''4\para~ |
      ...
      sol'2~ sol'8. fa'16 |
      mib'8. re'16 do'4.\prall do'8 |
      do'8. mib'32*2/3 re' do' sib8.\prall la16 re'4\para~ |
    ...
    \new Voice = "two" {
     ...
     \once \override Beam #'positions = #'(1.5 . 2.5) <sol' sib'\parb>8. <la' do''>16 re''2\parc |
     s2.*6 |
     \voiceTwo r4 r8 r16 re' do'8. re'16 |
     mib'4. re'8 do'8. re'16 |
     sib8.\parb do'16 re'2\parc | %}
    }
  >>
  \new Staff = "down" <<
    \global \clef "bass"
    \new Voice = "one" {
      ...
      \stemUp \stemLength #0.7 sol'2\parc \stemDown <fa' la'>4 |
      s4. do''8 <fa' sib' re''>4 |

<<
  \new Staff = "up" <<
    \global \clef "treble"
    {
      ...
      mib''2. sol''8 si' |
      << { \parenthesize do''4 do'''8 fa'' mi''4 sib''8 sol'' } \\
         { s4 
...
do''2 ~ <do'' mi''>4 } >>|
      <do'' fa'' \parenthesize lab''>2. do'''8 lab'' |
      << { fa''4-\prall fa''8 lab'' re''4. \mordent fa''8 } \\
         { \override Voice.Stem #'length-fraction = #0.7
           \override Voice.Beam #'length-fraction = #0.7
      ...
      r2 r4 mib' |
      \times 2/3 { re'8 [ mib' <fa' re'>8] } q8*2/3 q q q4 mib'4\mordent |
      re'8*2/3[ mib' <fa' re'>8*2/3] q[ q re''] <fa' re'>4 mib'\mordent |
      re'2. -\prall r4 |
      << { s4 sib' s mib'' | s sol'' s sib'' } \\
         \ru#8 { mib'16 sib mib' sol' } >>|
       mib''2\mordent ~ mib''16 fa'' sol'' fa'' mib'' re'' do'' sib' |
      do'' re'' mib'' re'' do'' sib' lab' sol' fa'4. -\prall sol'8 |
      \parenthesize lab'2 r8 fa''16 mib'' re'' do'' sib' lab' |
      ...
      << { \voiceOne mib''4 } \new Voice { \voiceTwo fa' \mordent } >>
      \oneVoice sib'8 fa' mib'' fa' << { re'' mi'' } \\ { sib' ~ <sib' sol'> } >>|
      << { \voiceOne fa''4\mordent } \new Voice { \voiceTwo lab' \mordent } >>
      \oneVoice lab'8 fa' do'' lab' fa'' ~ lab' |
      << { \voiceOne fa''4 } \new Voice { \voiceTwo sol'4 \mordent } >>
      \oneVoice do''8 sol' fa'' sol'
      << { mi''8 fad'' | sol''2\mordent } \\
         { do''8 ~ <do'' la'> | sib'2\mordent } >>
      r4 \voiceOne sib' \mordent |
      la'8*2/3[ sib' <la' do''>8*2/3] q[ q q] q4 sib'4\mordent |
      la'8*2/3[ sib' <la' do''>8*2/3] q[ q q] q4 sib'4\mordent |
      la' -\prall \oneVoice la'' \mordent ~ la''16 sol'' fad'' mi'' re'' do'' sib' la' |
      sib' re'' do'' sib' la' sol' sol' la' <fad' la'>4.\mordent sol'8 |
      << <re' sol'>2 \\ sib4 >> r sib' \mordent ~|
      sib' sol'8 mi' sol' do' do'' sol' |
      \parenthesize lab'4 r r lab' \mordent ~|
      lab' fa'8 re' fa' sib sib' fa' |
      \parenthesize sol'2 ~ << { \voiceTwo sol'4 <mib' sol'> |
                                 fa'2 \mordent ~ fa'8 fa' sol' re' | mib'4\mordent }
                               \new Voice {
                                 \voiceOne mib''2 ~| mib''4 re''8 do'' re''2 ~| re''4 } >>
      \oneVoice do''8 sib' lab' sol' fa'-\prall mib' |
      lab' sol' fa' mib' re' do' si -\prall la |
      sol2 r4 mib' \mordent |
      re'8*2/3[ mib' <re' fa'>8*2/3] q q q q4 mib'4\mordent |
      re'8*2/3[ mib' <re' fa'>8*2/3] q q re'' <re' fa'>4 mib'4\mordent |
      re'2. -\prall r4 |
      << { s4 do'' s mib'' |
           s sol'' s sol'' } \\
         \ru#8 { mib'16 do' mib' sol' } >>
      do'''2 \mordent ~ do'''4. sib''32*4/3 lab'' sol'' |
      lab''16 sib'' do''' sib'' lab'' sol'' fa'' mib'' re''4. -\prall mi''8 |
      \parenthesize fa''2 r8 re'''16 do''' si'' la'' sol'' fa'' |
  ...
  \new Staff = "down" <<
    ...
    { \set tieWaitForNote = ##t
      r2 r4 do'8 sol |
      mib'4 \mordent r r mib'8 do' |
      \downup sol'4 \mordent r r sol'8 mib' |
      do''2. \mordent sol'4 |
      lab'2 sol' |
      fa'2. sol'4 |
      lab'2 fa' |
      ...
      fa,2. lab8 fa |
      do'2. \mordent do4 |
      sol,2 r4 \downup sol'\mordent |
      <re' fad'> s2 sol'4\mordent |
      <re' fad'> s2 sol'4\mordent |
      <re' fad'>2 \downdown <fad la re'~> |
      ...
      sib2 \mordent si4. -\prall la16 si |
      do'4 do mib do |
      fa \mordent fa, lab, fa, |
      << { sol,2. \mordent do4 \mordent } \\ { r2 sol,,4 } >> |
      <sol si>4 s2 do'4\mordent |
      <sol si>4 s2 do'4\mordent |
      <sol si>2.-\prall r4 |
      ...
      do2 \mordent r4 do'16 sol mib do32 sol, |
      do,4
    }
  >>
>>